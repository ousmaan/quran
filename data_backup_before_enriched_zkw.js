...
const misconceptionsData = [
    ...
    // TOPIC 3: QURAN AS COMPLETE & SUFFICIENT GUIDANCE
    {
        ...
        sections: [
            ...
            },
            {
                type: "example",
                content: {
                    en: "Imagine buying a brand-new phone and ignoring the official manual from the manufacturer. Instead, you follow random advice from strangers online: one person says press this button, another says disable that setting, another says install this app. Soon your phone is misconfigured, and you blame the manufacturer: 'Your manual wasn’t enough!' This is how many people treat Allah’s Book: they leave the preserved guide and run after countless opinions. The Quran is the Creator’s guidance-manual — it is sufficient for the purpose it was sent for.",
                    ur: "مثال: آپ نے ایک نیا فون خریدا، لیکن کمپنی کی اصل (آفیشل) گائیڈ/مینول پڑھنے کی بجائے آپ ہر جگہ سے 'ٹپس' لینے لگے: کوئی کہتا ہے یہ بٹن ہمیشہ دباؤ، کوئی کہتا ہے وہ سیٹنگ بند کرو، کوئی کہتا ہے یہ ایپ لازمی ہے۔ نتیجہ یہ کہ فون کی سیٹنگ خراب ہو جاتی ہے اور پھر آپ کہتے ہیں: 'کمپنی کی گائیڈ کافی نہیں تھی!' یہی رویہ قرآن کے ساتھ ہے: اللہ کی محفوظ کتاب کو چھوڑ کر لوگ بے شمار آراء اور روایات کے پیچھے پڑ جاتے ہیں۔ قرآن خالق کی طرف سے ہدایت کا مینول ہے — اور جس مقصد کے لیے نازل ہوا، اس کے لیے کافی ہے۔"
                }
            },
            {
                type: "ayah",
            ...
            },
            {
                type: "example",
                content: {
                    en: "Think of a courtroom: a judge issues a written constitution and clear laws for the whole country. But citizens ignore the constitution and instead follow rumors, hearsay, and personal opinions. Then every city ends up with a different 'law' and people fight endlessly. Allah is telling you: the Book is the constitution for guidance. If something is truly necessary for salvation and accountability, it will be in Allah's Book — not dependent on unreliable chains, cultures, or personalities.",
                    ur: "مثال: ایک ملک میں آئین (Constitution) اور واضح قانون ہوتے ہیں۔ اگر لوگ آئین کو چھوڑ کر افواہوں، کہانیوں اور ہر شخص کی ذاتی رائے کو 'قانون' بنا لیں تو ہر شہر کا دین/قانون الگ ہو جائے گا اور جھگڑے کبھی ختم نہیں ہوں گے۔ اللہ ہمیں بتا رہا ہے کہ ہدایت کے لیے 'کتاب' ہی معیار ہے۔ جو چیز واقعی نجات اور جوابدہی کے لیے ضروری ہو گی، وہ اللہ کی کتاب میں ہو گی — ایسی چیز نہیں ہو گی جو ہر قوم کی رسم، ہر استاد کی رائے یا کمزور روایتوں پر ٹکی ہو۔"
                }
            },
            {
                type: "ayah",
            ...
            },
            {
                type: "example",
                content: {
                    en: "Picture a company where the CEO sends an official policy document to every employee: clear rules, clear priorities, and clear consequences. But employees say: 'We don't need the CEO's policy; we'll follow what our manager's friends say.' If two managers disagree, the office becomes chaos. In Islam, Allah is the Judge and the Quran is the official instruction. If you keep replacing it with other 'decision makers', you are practically appointing judges besides Allah.",
                    ur: "مثال: ایک کمپنی میں CEO ہر ملازم کو ایک آفیشل پالیسی ڈاکیومنٹ بھیجتا ہے: کیا جائز ہے، کیا ناجائز ہے، کیا ترجیح ہے، اور کیا نتیجہ نکلے گا۔ لیکن ملازم کہیں: 'ہمیں CEO کی پالیسی نہیں چاہیے، ہم مینیجر کے دوستوں کی بات مانیں گے۔' پھر ہر ڈپارٹمنٹ کا قانون الگ ہو جائے اور پورا نظام بگڑ جائے۔ دین میں اللہ ہی حاکم/جج ہے اور قرآن اس کی آفیشل ہدایت ہے۔ جب آپ بار بار قرآن کے علاوہ دوسروں کو فیصلہ کرنے والا بناتے ہیں تو حقیقت میں آپ اللہ کے سوا دوسرے 'جج' مقرر کر رہے ہوتے ہیں۔"
                }
            },
            {
                type: "ayah",
    ...
    id: 11,
    title: {
        en: "The Heart of Islam - Purification (Tazkiya & Zakat)",
        ur: "اسلام کا قلب - تزکیہ اور زکوٰۃ"
    },
    sections: [
        // ===== PART 1: FOUNDATION - What is Z-K-W? =====
        {
            type: "intro",
            subheading: {
                en: "Part 1: The Foundation - Understanding Z-K-W (ز-ک-و)",
                ur: "حصہ 1: بنیاد - ز-ک-و کو سمجھنا"
            },
            content: {
                en: "Everyone knows the word Zakat - it is one of the five pillars of Islam. But how many truly understand what it means? The Arabic root Z-K-W (ز-ک-و) appears over 50 times in the Quran, and it is not just about giving charity. It is about PURIFICATION and GROWTH - of your soul, your wealth, and your entire being. This is the heart of Islam, the core transformation that Allah asks from us.",
                ur: "ہر کوئی لفظ زکوٰۃ جانتا ہے - یہ اسلام کے پانچ ارکان میں سے ایک ہے۔ لیکن کتنے واقعی سمجھتے ہیں کہ اس کا مطلب کیا ہے؟ عربی جڑ ز-ک-و قرآن میں 50 سے زیادہ بار آتی ہے، اور یہ صرف خیرات دینے کے بارے میں نہیں۔ یہ تزکیہ اور ترقی کے بارے میں ہے - آپ کی روح کی، آپ کی دولت کی، اور آپ کے پورے وجود کی۔ یہ اسلام کا قلب ہے، وہ بنیادی تبدیلی جو اللہ ہم سے چاہتا ہے۔"
            }
        },
        ...
        // Success through purification
        {
            ...
            ayahEnd: 10,
            surahName: "Ash-Shams",
            arabic: "قَدْ أَفْلَحَ مَن زَكَّىٰهَا ۝ وَقَدْ خَابَ مَن دَسَّىٰهَا",
            wbw: [
                {arabic: "قَدْ", transliteration: "qad", en: "certainly", ur: "یقیناً", root: "", rootMeaning: "emphasis"},
                {arabic: "أَفْلَحَ", transliteration: "aflaha", en: "succeeded", ur: "کامیاب ہوا", root: "ف ل ح", rootMeaning: "success/prosperity"},
                {arabic: "مَن", transliteration: "man", en: "whoever", ur: "جس نے", root: "", rootMeaning: "who"},
                {arabic: "زَكَّىٰهَا", transliteration: "zakkaha", en: "purifies it", ur: "پاک کیا اسے", root: "ز ك و", rootMeaning: "purify/grow"},
                {arabic: "وَقَدْ", transliteration: "wa-qad", en: "and certainly", ur: "اور یقیناً", root: "", rootMeaning: "and emphasis"},
                {arabic: "خَابَ", transliteration: "khaba", en: "failed", ur: "ناکام ہوا", root: "خ ي ب", rootMeaning: "fail/lose"},
                {arabic: "مَن", transliteration: "man", en: "whoever", ur: "جس نے", root: "", rootMeaning: "who"},
                {arabic: "دَسَّىٰهَا", transliteration: "dassaha", en: "corrupts it", ur: "خراب کیا اسے", root: "د س و", rootMeaning: "corrupt/bury"}
            ],
            translation: {
                en: "He has certainly succeeded who purifies it (the soul), and he has certainly failed who corrupts it.",
                ur: "یقیناً کامیاب ہو گیا وہ جس نے اپنے نفس کو پاک کیا، اور یقیناً ناکام ہو گیا وہ جس نے اسے خراب کیا۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Allah defines SUCCESS and FAILURE in the clearest terms. Success is not wealth, status, or power. Success is PURIFYING your soul (zakkaha). Failure is not poverty or hardship. Failure is CORRUPTING your soul (dassaha). This is the ultimate criterion. Everything else is secondary.",
                ur: "اللہ نے کامیابی اور ناکامی کی واضح ترین تعریف بیان کی۔ کامیابی دولت، حیثیت یا طاقت نہیں۔ کامیابی اپنے نفس کو پاک کرنا ہے۔ ناکامی غربت یا مشکلات نہیں۔ ناکامی اپنے نفس کو خراب کرنا ہے۔ یہ حتمی معیار ہے۔ باقی سب چیزیں ثانوی ہیں۔"
            }
        },

        // He who purifies succeeds
        {
            type: "ayah",
            surah: 87,
            ayahNumber: 14,
            ...
            wbw: [
                {arabic: "قَدْ", transliteration: "qad", en: "certainly", ur: "یقیناً", root: "", rootMeaning: "emphasis"},
                {arabic: "أَفْلَحَ", transliteration: "aflaha", en: "succeeded", ur: "کامیاب ہوا", root: "ف ل ح", rootMeaning: "success"},
                {arabic: "مَن", transliteration: "man", en: "whoever", ur: "جس نے", root: "", rootMeaning: "who"},
                {arabic: "تَزَكَّىٰ", transliteration: "tazakka", en: "purified himself", ur: "پاک ہوا", root: "ز ك و", rootMeaning: "purify/grow"},
                {arabic: "وَذَكَرَ", transliteration: "wa-dhakara", en: "and remembered", ur: "اور یاد کیا", root: "ذ ك ر", rootMeaning: "remember"},
                {arabic: "ٱسْمَ", transliteration: "isma", en: "name", ur: "نام", root: "س م و", rootMeaning: "name"},
                {arabic: "رَبِّهِۦ", transliteration: "rabbihi", en: "of his Lord", ur: "اپنے رب کا", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "فَصَلَّىٰ", transliteration: "fa-salla", en: "and prayed", ur: "اور نماز پڑھی", root: "ص ل و", rootMeaning: "pray"}
            ],
            translation: {
                en: "He has certainly succeeded who purifies himself, and remembers the name of his Lord and prays.",
                ur: "یقیناً کامیاب ہو گیا وہ جو پاک ہو گیا، اور اپنے رب کا نام یاد کیا اور نماز پڑھی۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Notice the sequence: PURIFY yourself (tazakka) → REMEMBER Allah (dhikr) → PRAY (salah). Tazkiya comes FIRST. You cannot truly remember Allah or pray with a corrupted soul. Purification is the foundation of all worship.",
                ur: "ترتیب دیکھیں: خود کو پاک کرو → اللہ کو یاد کرو → نماز پڑھو۔ تزکیہ پہلے آتی ہے۔ آپ خراب نفس کے ساتھ واقعی اللہ کو یاد نہیں کر سکتے یا نماز نہیں پڑھ سکتے۔ تزکیہ تمام عبادت کی بنیاد ہے۔"
            }
        }
,
        // ===== PART 2: THE PROPHETIC MISSION - Tazkiya al-Nafs =====
        {
            type: "intro",
            subheading: {
                en: "Part 2: The Prophetic Mission - Purification of Souls",
                ur: "حصہ 2: نبوی مشن - نفوس کی تزکیہ"
            },
            content: {
                en: "What was the main job of every prophet? To teach religious rituals? To establish political systems? No. The PRIMARY mission of every messenger was TAZKIYA - the purification and transformation of human souls. Allah mentions this mission repeatedly in the Quran using almost identical words. This is not coincidence. This is emphasis.",
                ur: "ہر نبی کا بنیادی کام کیا تھا؟ مذہبی رسومات سکھانا؟ سیاسی نظام قائم کرنا؟ نہیں۔ ہر رسول کا بنیادی مشن تزکیہ تھا - انسانی نفوس کی پاکیزگی اور تبدیلی۔ اللہ نے اس مشن کا ذکر قرآن میں تقریباً یکساں الفاظ میں بار بار کیا ہے۔ یہ اتفاق نہیں۔ یہ زور ہے۔"
            }
        },

        // Ibrahim's dua for his descendants
        {
            type: "ayah",
            surah: 2,
            ayahNumber: 129,
            surahName: "Al-Baqarah",
            arabic: "رَبَّنَا وَٱبْعَثْ فِيهِمْ رَسُولًا مِّنْهُمْ يَتْلُوا۟ عَلَيْهِمْ ءَايَـٰتِكَ وَيُعَلِّمُهُمُ ٱلْكِتَـٰبَ وَٱلْحِكْمَةَ وَيُزَكِّيهِمْ ۚ إِنَّكَ أَنتَ ٱلْعَزِيزُ ٱلْحَكِيمُ",
            wbw: [
                {arabic: "رَبَّنَا", transliteration: "rabbana", en: "Our Lord", ur: "اے ہمارے رب", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "وَٱبْعَثْ", transliteration: "wa-ib'ath", en: "and raise", ur: "اور بھیج", root: "ب ع ث", rootMeaning: "raise/send"},
                {arabic: "فِيهِمْ", transliteration: "feehim", en: "among them", ur: "ان میں", root: "", rootMeaning: "in them"},
                {arabic: "رَسُولًا", transliteration: "rasoolan", en: "a messenger", ur: "ایک رسول", root: "ر س ل", rootMeaning: "messenger"},
                {arabic: "مِّنْهُمْ", transliteration: "minhum", en: "from them", ur: "ان میں سے", root: "", rootMeaning: "from them"},
                {arabic: "يَتْلُوا۟", transliteration: "yatloo", en: "who recites", ur: "جو تلاوت کرے", root: "ت ل و", rootMeaning: "recite/follow"},
                {arabic: "عَلَيْهِمْ", transliteration: "alayhim", en: "to them", ur: "ان پر", root: "", rootMeaning: "upon them"},
                {arabic: "ءَايَـٰتِكَ", transliteration: "ayatika", en: "Your verses", ur: "تیری آیات", root: "ء ي ي", rootMeaning: "signs/verses"},
                {arabic: "وَيُعَلِّمُهُمُ", transliteration: "wa-yu'allimuhum", en: "and teaches them", ur: "اور سکھائے ان کو", root: "ع ل م", rootMeaning: "teach/know"},
                {arabic: "ٱلْكِتَـٰبَ", transliteration: "al-kitab", en: "the Book", ur: "کتاب", root: "ك ت ب", rootMeaning: "write/book"},
                {arabic: "وَٱلْحِكْمَةَ", transliteration: "wal-hikmah", en: "and wisdom", ur: "اور حکمت", root: "ح ك م", rootMeaning: "wisdom"},
                {arabic: "وَيُزَكِّيهِمْ", transliteration: "wa-yuzakkihim", en: "and purifies them", ur: "اور پاک کرے ان کو", root: "ز ك و", rootMeaning: "purify/grow"},
                {arabic: "إِنَّكَ", transliteration: "innaka", en: "indeed You", ur: "بےشک تو", root: "", rootMeaning: "indeed"},
                {arabic: "أَنتَ", transliteration: "anta", en: "You", ur: "تو", root: "", rootMeaning: "you"},
                {arabic: "ٱلْعَزِيزُ", transliteration: "al-'azeez", en: "the All-Mighty", ur: "زبردست", root: "ع ز ز", rootMeaning: "mighty/honored"},
                {arabic: "ٱلْحَكِيمُ", transliteration: "al-hakeem", en: "the All-Wise", ur: "حکمت والا", root: "ح ك م", rootMeaning: "wise"}
            ],
            translation: {
                en: "Our Lord, and raise among them a messenger from themselves who will recite to them Your verses and teach them the Book and wisdom and purify them. Indeed, You are the All-Mighty, the All-Wise.",
                ur: "اے ہمارے رب، اور ان میں انہی میں سے ایک رسول بھیج جو ان پر تیری آیات تلاوت کرے، اور انہیں کتاب اور حکمت سکھائے، اور انہیں پاک کرے۔ بےشک تو زبردست اور حکمت والا ہے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Prophet Ibrahim (AS) built the Kaaba, but what did he pray for? A messenger who would do THREE things: 1) Recite verses, 2) Teach the Book and wisdom, 3) PURIFY people (yuzakkihim). Notice: knowledge without purification is incomplete. The goal is not just to know - it is to be TRANSFORMED.",
                ur: "نبی ابراہیم علیہ السلام نے کعبہ تعمیر کیا، لیکن انہوں نے کیا دعا کی؟ ایک رسول کے لیے جو تین کام کرے: 1) آیات تلاوت کرے، 2) کتاب اور حکمت سکھائے، 3) لوگوں کو پاک کرے۔ دیکھیں: علم بغیر تزکیہ کے نامکمل ہے۔ مقصد صرف جاننا نہیں - تبدیل ہونا ہے۔"
            }
        },

        // Allah's favor through Muhammad (saw)
        {
            type: "ayah",
            surah: 2,
            ayahNumber: 151,
            surahName: "Al-Baqarah",
            arabic: "كَمَآ أَرْسَلْنَا فِيكُمْ رَسُولًا مِّنكُمْ يَتْلُوا۟ عَلَيْكُمْ ءَايَـٰتِنَا وَيُزَكِّيكُمْ وَيُعَلِّمُكُمُ ٱلْكِتَـٰبَ وَٱلْحِكْمَةَ وَيُعَلِّمُكُم مَّا لَمْ تَكُونُوا۟ تَعْلَمُونَ",
            wbw: [
                {arabic: "كَمَآ", transliteration: "kama", en: "Just as", ur: "جیسے", root: "", rootMeaning: "just as"},
                {arabic: "أَرْسَلْنَا", transliteration: "arsalna", en: "We sent", ur: "ہم نے بھیجا", root: "ر س ل", rootMeaning: "send"},
                {arabic: "فِيكُمْ", transliteration: "feekum", en: "among you", ur: "تم میں", root: "", rootMeaning: "in you"},
                {arabic: "رَسُولًا", transliteration: "rasoolan", en: "a messenger", ur: "ایک رسول", root: "ر س ل", rootMeaning: "messenger"},
                {arabic: "مِّنكُمْ", transliteration: "minkum", en: "from yourselves", ur: "تم میں سے", root: "", rootMeaning: "from you"},
                {arabic: "يَتْلُوا۟", transliteration: "yatloo", en: "reciting", ur: "تلاوت کرتا ہے", root: "ت ل و", rootMeaning: "recite"},
                {arabic: "عَلَيْكُمْ", transliteration: "alaykum", en: "to you", ur: "تم پر", root: "", rootMeaning: "upon you"},
                {arabic: "ءَايَـٰتِنَا", transliteration: "ayatina", en: "Our verses", ur: "ہماری آیات", root: "ء ي ي", rootMeaning: "signs"},
                {arabic: "وَيُزَكِّيكُمْ", transliteration: "wa-yuzakkikum", en: "and purifying you", ur: "اور پاک کرتا ہے تم کو", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "وَيُعَلِّمُكُمُ", transliteration: "wa-yu'allimukum", en: "and teaching you", ur: "اور سکھاتا ہے تم کو", root: "ع ل م", rootMeaning: "teach"},
                {arabic: "ٱلْكِتَـٰبَ", transliteration: "al-kitab", en: "the Book", ur: "کتاب", root: "ك ت ب", rootMeaning: "book"},
                {arabic: "وَٱلْحِكْمَةَ", transliteration: "wal-hikmah", en: "and wisdom", ur: "اور حکمت", root: "ح ك م", rootMeaning: "wisdom"},
                {arabic: "وَيُعَلِّمُكُم", transliteration: "wa-yu'allimukum", en: "and teaching you", ur: "اور سکھاتا ہے تم کو", root: "ع ل م", rootMeaning: "teach"},
                {arabic: "مَّا", transliteration: "ma", en: "what", ur: "جو", root: "", rootMeaning: "what"},
                {arabic: "لَمْ", transliteration: "lam", en: "not", ur: "نہیں", root: "", rootMeaning: "not"},
                {arabic: "تَكُونُوا۟", transliteration: "takoonoo", en: "you were", ur: "تم تھے", root: "ك و ن", rootMeaning: "be/exist"},
                {arabic: "تَعْلَمُونَ", transliteration: "ta'lamoon", en: "knowing", ur: "جانتے", root: "ع ل م", rootMeaning: "know"}
            ],
            translation: {
                en: "Just as We sent among you a messenger from yourselves reciting to you Our verses and purifying you and teaching you the Book and wisdom and teaching you what you did not know.",
                ur: "جیسے ہم نے تم میں تم ہی میں سے ایک رسول بھیجا جو تم پر ہماری آیات تلاوت کرتا ہے، اور تمہیں پاک کرتا ہے، اور تمہیں کتاب اور حکمت سکھاتا ہے، اور تمہیں وہ سکھاتا ہے جو تم نہیں جانتے تھے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Allah fulfilled Ibrahim's dua. Notice the order HERE: Recite verses → PURIFY (yuzakki) → Teach Book and wisdom. Purification comes BEFORE deep teaching. Why? Because a corrupt heart cannot properly receive or apply knowledge. First clean the vessel, then fill it.",
                ur: "اللہ نے ابراہیم کی دعا قبول کی۔ یہاں ترتیب دیکھیں: آیات تلاوت کرو → پاک کرو → کتاب اور حکمت سکھاؤ۔ تزکیہ گہری تعلیم سے پہلے آتی ہے۔ کیوں؟ کیونکہ خراب دل علم کو صحیح طریقے سے وصول یا لاگو نہیں کر سکتا۔ پہلے برتن صاف کرو، پھر بھرو۔"
            }
        },

        // Allah's favor - same pattern
        {
            type: "ayah",
            surah: 3,
            ayahNumber: 164,
            surahName: "Al-Imran",
            arabic: "لَقَدْ مَنَّ ٱللَّهُ عَلَى ٱلْمُؤْمِنِينَ إِذْ بَعَثَ فِيهِمْ رَسُولًا مِّنْ أَنفُسِهِمْ يَتْلُوا۟ عَلَيْهِمْ ءَايَـٰتِهِۦ وَيُزَكِّيهِمْ وَيُعَلِّمُهُمُ ٱلْكِتَـٰبَ وَٱلْحِكْمَةَ وَإِن كَانُوا۟ مِن قَبْلُ لَفِى ضَلَـٰلٍۢ مُّبِينٍۢ",
            wbw: [
                {arabic: "لَقَدْ", transliteration: "laqad", en: "Certainly", ur: "یقیناً", root: "", rootMeaning: "certainly"},
                {arabic: "مَنَّ", transliteration: "manna", en: "bestowed favor", ur: "احسان کیا", root: "م ن ن", rootMeaning: "favor/bestow"},
                {arabic: "ٱللَّهُ", transliteration: "Allah", en: "Allah", ur: "اللہ", root: "ا ل ه", rootMeaning: "God"},
                {arabic: "عَلَى", transliteration: "ala", en: "upon", ur: "پر", root: "", rootMeaning: "upon"},
                {arabic: "ٱلْمُؤْمِنِينَ", transliteration: "al-mu'mineen", en: "the believers", ur: "ایمان والوں", root: "ء م ن", rootMeaning: "believe/faith"},
                {arabic: "إِذْ", transliteration: "idh", en: "when", ur: "جب", root: "", rootMeaning: "when"},
                {arabic: "بَعَثَ", transliteration: "ba'atha", en: "He raised", ur: "بھیجا", root: "ب ع ث", rootMeaning: "raise/send"},
                {arabic: "فِيهِمْ", transliteration: "feehim", en: "among them", ur: "ان میں", root: "", rootMeaning: "in them"},
                {arabic: "رَسُولًا", transliteration: "rasoolan", en: "a messenger", ur: "رسول", root: "ر س ل", rootMeaning: "messenger"},
                {arabic: "مِّنْ", transliteration: "min", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "أَنفُسِهِمْ", transliteration: "anfusihim", en: "themselves", ur: "ان کے اپنے میں سے", root: "ن ف س", rootMeaning: "self/soul"},
                {arabic: "يَتْلُوا۟", transliteration: "yatloo", en: "reciting", ur: "تلاوت کرتا", root: "ت ل و", rootMeaning: "recite"},
                {arabic: "عَلَيْهِمْ", transliteration: "alayhim", en: "to them", ur: "ان پر", root: "", rootMeaning: "upon them"},
                {arabic: "ءَايَـٰتِهِۦ", transliteration: "ayatihi", en: "His verses", ur: "اس کی آیات", root: "ء ي ي", rootMeaning: "signs"},
                {arabic: "وَيُزَكِّيهِمْ", transliteration: "wa-yuzakkihim", en: "and purifying them", ur: "اور پاک کرتا ان کو", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "وَيُعَلِّمُهُمُ", transliteration: "wa-yu'allimuhum", en: "and teaching them", ur: "اور سکھاتا ان کو", root: "ع ل م", rootMeaning: "teach"},
                {arabic: "ٱلْكِتَـٰبَ", transliteration: "al-kitab", en: "the Book", ur: "کتاب", root: "ك ت ب", rootMeaning: "book"},
                {arabic: "وَٱلْحِكْمَةَ", transliteration: "wal-hikmah", en: "and wisdom", ur: "اور حکمت", root: "ح ك م", rootMeaning: "wisdom"}
            ],
            translation: {
                en: "Certainly Allah has bestowed favor upon the believers when He raised among them a messenger from themselves, reciting to them His verses and purifying them and teaching them the Book and wisdom, although they had been before in clear error.",
                ur: "یقیناً اللہ نے ایمان والوں پر احسان کیا جب ان میں انہی میں سے ایک رسول بھیجا، جو ان پر اس کی آیات تلاوت کرتا ہے، اور انہیں پاک کرتا ہے، اور انہیں کتاب اور حکمت سکھاتا ہے، حالانکہ وہ اس سے پہلے واضح گمراہی میں تھے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Allah calls sending a messenger who PURIFIES people a FAVOR (manna). Not just teaching, not just reciting - but PURIFYING. From clear error (dhalal mubeen) to guidance. This is the transformation Islam offers. Without tazkiya, you may know Islam but not BE a Muslim in the true sense.",
                ur: "اللہ نے ایک رسول بھیجنا جو لوگوں کو پاک کرے، ایک احسان (من) کہا۔ صرف تعلیم نہیں، صرف تلاوت نہیں - بلکہ پاک کرنا۔ واضح گمراہی سے ہدایت کی طرف۔ یہ وہ تبدیلی ہے جو اسلام پیش کرتا ہے۔ تزکیہ کے بغیر، آپ اسلام جان سکتے ہیں لیکن حقیقی معنوں میں مسلمان نہیں ہو سکتے۔"
            }
        }
,
        // ===== PART 3: SELF-PURIFICATION - Your Personal Journey =====
        {
            type: "intro",
            subheading: {
                en: "Part 3: Self-Purification - Your Personal Responsibility",
                ur: "حصہ 3: خود کی تزکیہ - آپ کی ذاتی ذمہ داری"
            },
            content: {
                en: "The prophets came to guide us, but ultimately each person must purify THEMSELVES. No one can do it for you. Not your parents, not your imam, not your sheikh. This is YOUR journey. The Quran emphasizes personal responsibility for tazkiya again and again. Let's see how.",
                ur: "نبی ہماری رہنمائی کے لیے آئے، لیکن بالآخر ہر شخص کو خود کو پاک کرنا ہوگا۔ کوئی آپ کے لیے نہیں کر سکتا۔ نہ آپ کے والدین، نہ آپ کا امام، نہ آپ کا شیخ۔ یہ آپ کا سفر ہے۔ قرآن بار بار تزکیہ کی ذاتی ذمہ داری پر زور دیتا ہے۔ آئیے دیکھتے ہیں کیسے۔"
            }
        },

        // Gardens for those who purify
        {
            type: "ayah",
            surah: 20,
            ayahNumber: 76,
            surahName: "Ta-Ha",
            arabic: "جَنَّـٰتُ عَدْنٍۢ تَجْرِى مِن تَحْتِهَا ٱلْأَنْهَـٰرُ خَـٰلِدِينَ فِيهَا ۚ وَذَٰلِكَ جَزَآءُ مَن تَزَكَّىٰ",
            wbw: [
                {arabic: "جَنَّـٰتُ", transliteration: "jannatu", en: "Gardens", ur: "جنتیں", root: "ج ن ن", rootMeaning: "garden/covered"},
                {arabic: "عَدْنٍۢ", transliteration: "adn", en: "of Eden", ur: "ہمیشگی کی", root: "ع د ن", rootMeaning: "eternity/permanence"},
                {arabic: "تَجْرِى", transliteration: "tajree", en: "flow", ur: "بہتی ہیں", root: "ج ر ي", rootMeaning: "flow/run"},
                {arabic: "مِن", transliteration: "min", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "تَحْتِهَا", transliteration: "tahtiha", en: "beneath it", ur: "اس کے نیچے", root: "ت ح ت", rootMeaning: "beneath"},
                {arabic: "ٱلْأَنْهَـٰرُ", transliteration: "al-anhar", en: "the rivers", ur: "ندیاں", root: "ن ه ر", rootMeaning: "river"},
                {arabic: "خَـٰلِدِينَ", transliteration: "khalideen", en: "abiding forever", ur: "ہمیشہ رہنے والے", root: "خ ل د", rootMeaning: "eternal/immortal"},
                {arabic: "فِيهَا", transliteration: "feeha", en: "in it", ur: "اس میں", root: "", rootMeaning: "in it"},
                {arabic: "وَذَٰلِكَ", transliteration: "wa-dhalika", en: "and that", ur: "اور یہ", root: "", rootMeaning: "and that"},
                {arabic: "جَزَآءُ", transliteration: "jazaa'u", en: "reward", ur: "بدلہ", root: "ج ز ي", rootMeaning: "reward/recompense"},
                {arabic: "مَن", transliteration: "man", en: "of who", ur: "اس کا جس نے", root: "", rootMeaning: "who"},
                {arabic: "تَزَكَّىٰ", transliteration: "tazakka", en: "purifies himself", ur: "خود کو پاک کیا", root: "ز ك و", rootMeaning: "purify/grow"}
            ],
            translation: {
                en: "Gardens of Eden beneath which rivers flow, wherein they abide eternally. And that is the reward of whoever purifies himself.",
                ur: "ہمیشگی کی جنتیں جن کے نیچے نہریں بہتی ہیں، اس میں ہمیشہ رہنے والے۔ اور یہ اس کا بدلہ ہے جس نے خود کو پاک کیا۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Eternal gardens - the ultimate reward - for WHO? 'Man tazakka' - whoever purifies HIMSELF. Not 'who was purified by someone else.' The verb is reflexive. YOU must do it. This is active, not passive. Self-purification is the ticket to Jannah.",
                ur: "ہمیشہ کی جنتیں - حتمی انعام - کس کے لیے؟ 'من تزکّٰی' - جس نے خود کو پاک کیا۔ 'جسے کسی اور نے پاک کیا' نہیں۔ فعل واپسی ہے۔ آپ کو یہ کرنا ہوگا۔ یہ فعال ہے، منفعل نہیں۔ خود تزکیہ جنت کا ٹکٹ ہے۔"
            }
        },
        ...
        // No one bears another's burden
        {
            ...
            ayahNumber: 18,
            surahName: "Fatir",
            arabic: "وَلَا تَزِرُ وَازِرَةٌۭ وِزْرَ أُخْرَىٰ ۚ وَإِن تَدْعُ مُثْقَلَةٌ إِلَىٰ حِمْلِهَا لَا يُحْمَلْ مِنْهُ شَىْءٌۭ وَلَوْ كَانَ ذَا قُرْبَىٰٓ",
            wbw: [
                {arabic: "وَلَا", transliteration: "wa-la", en: "And not", ur: "اور نہیں", root: "", rootMeaning: "and not"},
                {arabic: "تَزِرُ", transliteration: "taziru", en: "will bear", ur: "اٹھائے گا", root: "و ز ر", rootMeaning: "burden/sin"},
                {arabic: "وَازِرَةٌۭ", transliteration: "waziratun", en: "one laden with burden", ur: "بوجھ اٹھانے والا", root: "و ز ر", rootMeaning: "burden"},
                {arabic: "وِزْرَ", transliteration: "wizra", en: "burden", ur: "بوجھ", root: "و ز ر", rootMeaning: "burden"},
                {arabic: "أُخْرَىٰ", transliteration: "ukhra", en: "of another", ur: "دوسرے کا", root: "", rootMeaning: "another"},
                {arabic: "وَإِن", transliteration: "wa-in", en: "And if", ur: "اور اگر", root: "", rootMeaning: "and if"},
                {arabic: "تَدْعُ", transliteration: "tad'u", en: "calls", ur: "پکارے", root: "د ع و", rootMeaning: "call"},
                {arabic: "مُثْقَلَةٌ", transliteration: "muthqalatun", en: "one heavily laden", ur: "بھاری بوجھ والا", root: "ث ق ل", rootMeaning: "heavy/weighty"},
                {arabic: "إِلَىٰ", transliteration: "ila", en: "to", ur: "کی طرف", root: "", rootMeaning: "to"},
                {arabic: "حِمْلِهَا", transliteration: "himliha", en: "its burden", ur: "اس کے بوجھ", root: "ح م ل", rootMeaning: "carry/burden"},
                {arabic: "لَا", transliteration: "la", en: "not", ur: "نہیں", root: "", rootMeaning: "not"},
                {arabic: "يُحْمَلْ", transliteration: "yuhmal", en: "will be carried", ur: "اٹھایا جائے گا", root: "ح م ل", rootMeaning: "carry"},
                {arabic: "مِنْهُ", transliteration: "minhu", en: "from it", ur: "اس میں سے", root: "", rootMeaning: "from it"},
                {arabic: "شَىْءٌۭ", transliteration: "shay'un", en: "anything", ur: "کچھ بھی", root: "ش ي ء", rootMeaning: "thing"}
            ],
            translation: {
                en: "And no bearer of burdens will bear the burden of another. And if a heavily laden soul calls another to carry its load, nothing of it will be carried, even if he is a close relative.",
                ur: "اور کوئی بوجھ اٹھانے والا دوسرے کا بوجھ نہیں اٹھائے گا۔ اور اگر کوئی بھاری بوجھ والا اپنے بوجھ کے لیے پکارے، تو اس میں سے کچھ بھی نہیں اٹھایا جائے گا، چاہے وہ قریبی رشتہ دار ہی کیوں نہ ہو۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Personal accountability. No one - not even your closest family - can carry your burden of purification. You cannot outsource tazkiya to a pir, a scholar, or a sheikh. It is YOUR soul, YOUR responsibility, YOUR journey. Stop relying on others for what only YOU can do.",
                ur: "ذاتی جوابدہی۔ کوئی نہیں - یہاں تک کہ آپ کا قریب ترین خاندان بھی نہیں - آپ کی تزکیہ کا بوجھ نہیں اٹھا سکتا۔ آپ تزکیہ کو کسی پیر، عالم یا شیخ کو آؤٹ سورس نہیں کر سکتے۔ یہ آپ کی روح ہے، آپ کی ذمہ داری، آپ کا سفر۔ دوسروں پر انحصار چھوڑیں اس چیز کے لیے جو صرف آپ کر سکتے ہیں۔"
            }
        },

        // Perhaps he purifies himself
        {
            type: "ayah",
            surah: 80,
            ayahNumber: 3,
            ayahEnd: 4,
            surahName: "Abasa",
            arabic: "وَمَا يُدْرِيكَ لَعَلَّهُۥ يَزَّكَّىٰٓ ۝ أَوْ يَذَّكَّرُ فَتَنفَعَهُ ٱلذِّكْرَىٰ",
            wbw: [
                {arabic: "وَمَا", transliteration: "wa-ma", en: "And what", ur: "اور کیا", root: "", rootMeaning: "and what"},
                {arabic: "يُدْرِيكَ", transliteration: "yudreeka", en: "makes you know", ur: "جانتا ہے تجھے", root: "د ر ي", rootMeaning: "know/perceive"},
                {arabic: "لَعَلَّهُۥ", transliteration: "la'allahu", en: "perhaps he", ur: "شاید وہ", root: "", rootMeaning: "perhaps"},
                {arabic: "يَزَّكَّىٰٓ", transliteration: "yazzakka", en: "purifies himself", ur: "پاک ہو جائے", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "أَوْ", transliteration: "aw", en: "Or", ur: "یا", root: "", rootMeaning: "or"},
                {arabic: "يَذَّكَّرُ", transliteration: "yadhdhakkaru", en: "be reminded", ur: "نصیحت لے", root: "ذ ك ر", rootMeaning: "remember"},
                {arabic: "فَتَنفَعَهُ", transliteration: "fa-tanfa'ahu", en: "and benefit him", ur: "تو فائدہ دے اسے", root: "ن ف ع", rootMeaning: "benefit"},
                {arabic: "ٱلذِّكْرَىٰ", transliteration: "adh-dhikra", en: "the reminder", ur: "یاد دہانی", root: "ذ ك ر", rootMeaning: "remembrance"}
            ],
            translation: {
                en: "And what would make you know? Perhaps he might purify himself, or be reminded and the reminder would benefit him.",
                ur: "اور تمہیں کیا معلوم؟ شاید وہ پاک ہو جائے، یا نصیحت لے اور یاد دہانی اسے فائدہ دے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Context: A blind man came to the Prophet seeking knowledge while he was busy with influential people. Allah rebuked the Prophet for turning away. Why? Because that blind man came seeking to PURIFY himself (yazzakka). Anyone genuinely seeking tazkiya deserves attention, regardless of their social status. Purification is the true priority.",
                ur: "سیاق: ایک نابینا آدمی نبی کے پاس علم کے لیے آیا جبکہ وہ بااثر لوگوں سے مصروف تھے۔ اللہ نے نبی کو منہ موڑنے پر ملامت کی۔ کیوں؟ کیونکہ وہ نابینا آدمی خود کو پاک کرنے آیا تھا۔ جو بھی حقیقی طور پر تزکیہ چاہتا ہو، توجہ کا مستحق ہے، ان کی سماجی حیثیت سے قطع نظر۔ تزکیہ حقیقی ترجیح ہے۔"
            }
        },

        // Restraining desires for purification  
        {
            type: "ayah",
            surah: 79,
            ayahNumber: 40,
            ...
            wbw: [
                {arabic: "وَأَمَّا", transliteration: "wa-amma", en: "But as for", ur: "اور جو", root: "", rootMeaning: "but as for"},
                {arabic: "مَنْ", transliteration: "man", en: "who", ur: "جس نے", root: "", rootMeaning: "who"},
                {arabic: "خَافَ", transliteration: "khafa", en: "feared", ur: "ڈرا", root: "خ و ف", rootMeaning: "fear"},
                {arabic: "مَقَامَ", transliteration: "maqama", en: "standing", ur: "کھڑا ہونا", root: "ق و م", rootMeaning: "stand/position"},
                {arabic: "رَبِّهِۦ", transliteration: "rabbihi", en: "of his Lord", ur: "اپنے رب کے سامنے", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "وَنَهَى", transliteration: "wa-naha", en: "and restrained", ur: "اور روکا", root: "ن ه ي", rootMeaning: "forbid/restrain"},
                {arabic: "ٱلنَّفْسَ", transliteration: "an-nafsa", en: "the soul", ur: "نفس کو", root: "ن ف س", rootMeaning: "soul/self"},
                {arabic: "عَنِ", transliteration: "an", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "ٱلْهَوَىٰ", transliteration: "al-hawa", en: "vain desires", ur: "خواہشات", root: "ه و ي", rootMeaning: "desire/whim"},
                {arabic: "فَإِنَّ", transliteration: "fa-inna", en: "then indeed", ur: "تو بےشک", root: "", rootMeaning: "then indeed"},
                {arabic: "ٱلْجَنَّةَ", transliteration: "al-jannah", en: "Paradise", ur: "جنت", root: "ج ن ن", rootMeaning: "garden"},
                {arabic: "هِىَ", transliteration: "hiya", en: "it is", ur: "ہے", root: "", rootMeaning: "it"},
                {arabic: "ٱلْمَأْوَىٰ", transliteration: "al-ma'wa", en: "the refuge", ur: "ٹھکانا", root: "ء و ي", rootMeaning: "shelter/refuge"}
            ],
            translation: {
                en: "But as for he who feared standing before his Lord and restrained the soul from vain desires, then indeed Paradise will be his refuge.",
                ur: "اور جس نے اپنے رب کے سامنے کھڑے ہونے سے ڈرا اور نفس کو خواہشات سے روکا، تو بےشک جنت اس کا ٹھکانا ہے۔"
            }
        },
...
,
        // ===== PART 4: WEALTH PURIFICATION - Zakat =====
        {
            type: "intro",
            subheading: {
                en: "Part 4: Purification of Wealth - Zakat",
                ur: "حصہ 4: دولت کی تزکیہ - زکوٰۃ"
            },
            content: {
                en: "Now we come to what most people think of when they hear the word 'Zakat' - giving from your wealth. But even here, the Quran's focus is not on charity for the poor's sake alone. It's about purifying YOUR soul through your wealth. The disease is attachment. The cure is giving. Let's see what Allah says.",
                ur: "اب ہم اس چیز پر آتے ہیں جو زیادہ تر لوگ سوچتے ہیں جب وہ لفظ 'زکوٰۃ' سنتے ہیں - اپنی دولت سے دینا۔ لیکن یہاں بھی، قرآن کی توجہ صرف غریبوں کی خاطر خیرات پر نہیں۔ یہ آپ کی دولت کے ذریعے آپ کی روح کو پاک کرنے کے بارے میں ہے۔ بیماری لگاؤ ہے۔ علاج دینا ہے۔ آئیے دیکھتے ہیں اللہ کیا کہتا ہے۔"
            }
        },
        ...
        // Take from their wealth to purify them
        {
            ...
            ayahNumber: 103,
            surahName: "At-Tawbah",
            arabic: "خُذْ مِنْ أَمْوَٰلِهِمْ صَدَقَةًۭ تُطَهِّرُهُمْ وَتُزَكِّيهِم بِهَا وَصَلِّ عَلَيْهِمْ ۖ إِنَّ صَلَوٰتَكَ سَكَنٌۭ لَّهُمْ ۗ وَٱللَّهُ سَمِيعٌ عَلِيمٌۭ",
            wbw: [
                {arabic: "خُذْ", transliteration: "khudh", en: "Take", ur: "لے لو", root: "ء خ ذ", rootMeaning: "take"},
                {arabic: "مِنْ", transliteration: "min", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "أَمْوَٰلِهِمْ", transliteration: "amwalihim", en: "their wealth", ur: "ان کی دولت", root: "م و ل", rootMeaning: "wealth/property"},
                {arabic: "صَدَقَةًۭ", transliteration: "sadaqatan", en: "charity", ur: "صدقہ", root: "ص د ق", rootMeaning: "truthfulness/charity"},
                {arabic: "تُطَهِّرُهُمْ", transliteration: "tutahhiruhum", en: "purify them", ur: "پاک کرو ان کو", root: "ط ه ر", rootMeaning: "purify/cleanse"},
                {arabic: "وَتُزَكِّيهِم", transliteration: "wa-tuzakkihim", en: "and sanctify them", ur: "اور پاک کرو ان کو", root: "ز ك و", rootMeaning: "purify/grow"},
                {arabic: "بِهَا", transliteration: "biha", en: "with it", ur: "اس سے", root: "", rootMeaning: "with it"},
                {arabic: "وَصَلِّ", transliteration: "wa-salli", en: "and pray", ur: "اور دعا کرو", root: "ص ل و", rootMeaning: "pray"},
                {arabic: "عَلَيْهِمْ", transliteration: "alayhim", en: "for them", ur: "ان کے لیے", root: "", rootMeaning: "upon them"},
                {arabic: "إِنَّ", transliteration: "inna", en: "indeed", ur: "بےشک", root: "", rootMeaning: "indeed"},
                {arabic: "صَلَوٰتَكَ", transliteration: "salawataka", en: "your prayers", ur: "تمہاری دعائیں", root: "ص ل و", rootMeaning: "prayer"},
                {arabic: "سَكَنٌۭ", transliteration: "sakanun", en: "a reassurance", ur: "سکون", root: "س ك ن", rootMeaning: "tranquility"},
                {arabic: "لَّهُمْ", transliteration: "lahum", en: "for them", ur: "ان کے لیے", root: "", rootMeaning: "for them"}
            ],
            translation: {
                en: "Take from their wealth a charity by which you purify them and sanctify them, and pray for them. Indeed, your prayers are reassurance for them. And Allah is Hearing and Knowing.",
                ur: "ان کی دولت سے صدقہ لے لو جس سے تم انہیں پاک کرو اور ان کو پاک کرو، اور ان کے لیے دعا کرو۔ بےشک تمہاری دعائیں ان کے لیے سکون ہیں۔ اور اللہ سننے والا جاننے والا ہے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Notice TWO words for purification: Tutahhiruhum (cleanse them) AND tuzakkihim (purify/grow them). Zakat is not just removing impurity - it's GROWTH. When you give, you cleanse your heart from greed AND you grow in generosity, trust in Allah, and spiritual strength. The charity purifies the GIVER more than it helps the receiver.",
                ur: "تزکیہ کے لیے دو الفاظ دیکھیں: تطہرھم (انہیں صاف کرو) اور تزکیھم (انہیں پاک کرو/بڑھاؤ)۔ زکوٰۃ صرف ناپاکی دور کرنا نہیں - یہ ترقی ہے۔ جب آپ دیتے ہیں، تو آپ اپنے دل کو لالچ سے صاف کرتے ہیں اور سخاوت، اللہ پر بھروسہ، اور روحانی طاقت میں بڑھتے ہیں۔ صدقہ لینے والے کی مدد سے زیادہ دینے والے کو پاک کرتا ہے۔"
            }
        },

        // Salah and Zakat - the constant pairing
        {
            type: "ayah",
            surah: 2,
            ayahNumber: 110,
            ...
            wbw: [
                {arabic: "وَأَقِيمُوا۟", transliteration: "wa-aqeemu", en: "And establish", ur: "اور قائم کرو", root: "ق و م", rootMeaning: "establish/stand"},
                {arabic: "ٱلصَّلَوٰةَ", transliteration: "as-salah", en: "the prayer", ur: "نماز", root: "ص ل و", rootMeaning: "prayer"},
                {arabic: "وَءَاتُوا۟", transliteration: "wa-aatoo", en: "and give", ur: "اور دو", root: "ء ت ي", rootMeaning: "give/bring"},
                {arabic: "ٱلزَّكَوٰةَ", transliteration: "az-zakah", en: "the zakah", ur: "زکوٰۃ", root: "ز ك و", rootMeaning: "purification"},
                {arabic: "وَمَا", transliteration: "wa-ma", en: "And whatever", ur: "اور جو کچھ", root: "", rootMeaning: "and what"},
                {arabic: "تُقَدِّمُوا۟", transliteration: "tuqaddimoo", en: "you send forth", ur: "آگے بھیجو", root: "ق د م", rootMeaning: "advance/precede"},
                {arabic: "لِأَنفُسِكُم", transliteration: "li-anfusikum", en: "for yourselves", ur: "اپنے لیے", root: "ن ف س", rootMeaning: "self/soul"},
                {arabic: "مِّنْ", transliteration: "min", en: "of", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "خَيْرٍۢ", transliteration: "khayr", en: "good", ur: "بھلائی", root: "خ ي ر", rootMeaning: "good"},
                {arabic: "تَجِدُوهُ", transliteration: "tajidoohu", en: "you will find it", ur: "پاؤ گے اسے", root: "و ج د", rootMeaning: "find"},
                {arabic: "عِندَ", transliteration: "inda", en: "with", ur: "کے پاس", root: "", rootMeaning: "with/near"},
                {arabic: "ٱللَّهِ", transliteration: "Allah", en: "Allah", ur: "اللہ", root: "ا ل ه", rootMeaning: "God"}
            ],
            translation: {
                en: "And establish prayer and give zakah, and whatever good you send forth for yourselves, you will find it with Allah. Indeed, Allah is Seeing of what you do.",
                ur: "اور نماز قائم کرو اور زکوٰۃ دو، اور جو کچھ بھلائی تم اپنے لیے آگے بھیجو گے، اسے اللہ کے پاس پاؤ گے۔ بےشک اللہ دیکھ رہا ہے جو تم کرتے ہو۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Salah and Zakat appear together over 30 times in the Quran. Why? Because purification of soul (salah - spiritual) and purification of wealth (zakat - material) go hand in hand. You cannot truly worship Allah while clinging to money. And notice: 'whatever good you send forth FOR YOURSELVES' - you are not doing charity for others. You are investing for YOUR OWN soul.",
                ur: "نماز اور زکوٰۃ قرآن میں 30 سے زیادہ بار اکٹھے آتے ہیں۔ کیوں؟ کیونکہ روح کی تزکیہ (نماز - روحانی) اور دولت کی تزکیہ (زکوٰۃ - مادی) ساتھ ساتھ چلتی ہیں۔ آپ سچے معنوں میں اللہ کی عبادت نہیں کر سکتے جب تک رقم سے چمٹے ہوئے ہیں۔ اور دیکھیں: 'جو کچھ بھلائی تم اپنے لیے آگے بھیجو' - آپ دوسروں کے لیے خیرات نہیں کر رہے۔ آپ اپنی روح کے لیے سرمایہ کاری کر رہے ہیں۔"
            }
        },

        // The disease: counting wealth thinking it makes immortal
        {
            type: "ayah",
            surah: 104,
            ayahNumber: 2,
            ...
            arabic: "جَمَعَ مَالًۭا وَعَدَّدَهُۥ ۝ يَحْسَبُ أَنَّ مَالَهُۥٓ أَخْلَدَهُۥ",
            wbw: [
                {arabic: "جَمَعَ", transliteration: "jama'a", en: "He amasses", ur: "جمع کیا", root: "ج م ع", rootMeaning: "gather/collect"},
                {arabic: "مَالًۭا", transliteration: "malan", en: "wealth", ur: "مال", root: "م و ل", rootMeaning: "wealth"},
                {arabic: "وَعَدَّدَهُۥ", transliteration: "wa-'addadahu", en: "and counts it", ur: "اور گنتا ہے اسے", root: "ع د د", rootMeaning: "count/number"},
                {arabic: "يَحْسَبُ", transliteration: "yahsabu", en: "He thinks", ur: "گمان کرتا ہے", root: "ح س ب", rootMeaning: "think/reckon"},
                {arabic: "أَنَّ", transliteration: "anna", en: "that", ur: "کہ", root: "", rootMeaning: "that"},
                {arabic: "مَالَهُۥٓ", transliteration: "malahu", en: "his wealth", ur: "اس کا مال", root: "م و ل", rootMeaning: "wealth"},
                {arabic: "أَخْلَدَهُۥ", transliteration: "akhladahu", en: "will make him immortal", ur: "ہمیشہ رہنے والا بنائے گا", root: "خ ل د", rootMeaning: "immortal/eternal"}
            ],
            translation: {
                en: "Who gathers wealth and counts it repeatedly, thinking that his wealth will make him immortal.",
                ur: "جس نے مال جمع کیا اور بار بار گنتا ہے، یہ سوچتے ہوئے کہ اس کا مال اسے ہمیشہ رہنے والا بنا دے گا۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "This is the DISEASE. Amassing wealth and counting it repeatedly (wa-'addadahu - obsessively checking your bank account, stocks, assets). Why? Deep down, you think wealth = security = immortality. This is shirk of the heart. You trust money more than Allah. Zakat is the cure - it FORCES you to let go and trust Allah instead.",
                ur: "یہ بیماری ہے۔ مال جمع کرنا اور بار بار گننا (و عددہ - بار بار اپنا بینک اکاؤنٹ، اسٹاکس، اثاثے چیک کرنا)۔ کیوں؟ اندر سے، آپ سوچتے ہیں کہ دولت = سیکیورٹی = ہمیشگی۔ یہ دل کا شرک ہے۔ آپ اللہ سے زیادہ پیسے پر بھروسہ کرتے ہیں۔ زکوٰۃ علاج ہے - یہ آپ کو چھوڑنے اور اس کے بجائے اللہ پر بھروسہ کرنے پر مجبور کرتی ہے۔"
            }
        },
        ...
        // The distraction
        {
            ...
            arabic: "ٱلْهَىٰكُمُ ٱلتَّكَاثُرُ ۝ حَتَّىٰ زُرْتُمُ ٱلْمَقَابِرَ",
            wbw: [
                {arabic: "ٱلْهَىٰكُمُ", transliteration: "alhakum", en: "Distracts you", ur: "مشغول کیا تم کو", root: "ل ه و", rootMeaning: "distract/amuse"},
                {arabic: "ٱلتَّكَاثُرُ", transliteration: "at-takathur", en: "the competition in increase", ur: "زیادہ کرنے کی ہوڑ", root: "ك ث ر", rootMeaning: "increase/multiply"},
                {arabic: "حَتَّىٰ", transliteration: "hatta", en: "Until", ur: "یہاں تک کہ", root: "", rootMeaning: "until"},
                {arabic: "زُرْتُمُ", transliteration: "zurtum", en: "you visit", ur: "تم گئے", root: "ز و ر", rootMeaning: "visit"},
                {arabic: "ٱلْمَقَابِرَ", transliteration: "al-maqabir", en: "the graves", ur: "قبروں کو", root: "ق ب ر", rootMeaning: "grave/tomb"}
            ],
            translation: {
                en: "Competition in worldly increase distracts you, until you visit the graves.",
                ur: "دنیا میں زیادہ کرنے کی ہوڑ نے تمہیں مشغول کر دیا، یہاں تک کہ تم قبروں کو چلے گئے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "At-Takathur - competing to accumulate MORE. More money, more status, more followers, more likes. This competition DISTRACTS you from your real purpose until death comes. Zakat breaks this cycle. It says: STOP accumulating. START purifying. Give regularly, and your heart will detach from the race.",
                ur: "التکاثر - زیادہ جمع کرنے کی مقابلہ۔ زیادہ پیسہ، زیادہ حیثیت، زیادہ فالورز، زیادہ لائکس۔ یہ مقابلہ آپ کو آپ کے حقیقی مقصد سے ہٹا دیتا ہے یہاں تک کہ موت آ جائے۔ زکوٰۃ اس سائیکل کو توڑتی ہے۔ یہ کہتی ہے: جمع کرنا بند کرو۔ پاک کرنا شروع کرو۔ باقاعدگی سے دو، اور آپ کا دل اس دوڑ سے الگ ہو جائے گا۔"
            }
        }
,
        // EXAMPLE 1: The Two Gardens - Wealth without Tazkiya
        {
            type: "example",
            subheading: {
                en: "Example: The Story of the Two Gardens",
                ur: "مثال: دو باغوں کی کہانی"
            },
            content: {
                en: "Allah tells us about a man with two beautiful gardens - vineyards, date palms, rivers flowing through them. He had EVERYTHING materially. But he lacked one thing: gratitude and recognition that it all came from Allah. He boasted to his friend: 'I have more wealth and stronger followers than you. My wealth will never perish.' His friend warned him: 'Do you disbelieve in your Creator? Say: This is what Allah willed!' But he refused. What happened? Allah destroyed both gardens overnight. The man was left wringing his hands in regret. The lesson: Wealth without tazkiya (purification through gratitude and charity) leads to destruction, both in this life and the next.",
                ur: "اللہ نے ہمیں ایک آدمی کے بارے میں بتایا جس کے دو خوبصورت باغ تھے - انگور، کھجور، ان میں سے ندیاں بہتی تھیں۔ اس کے پاس مادی طور پر سب کچھ تھا۔ لیکن اس میں ایک چیز کی کمی تھی: شکر گزاری اور یہ تسلیم کرنا کہ یہ سب اللہ کی طرف سے ہے۔ اس نے اپنے دوست سے فخر کیا: 'میرے پاس تم سے زیادہ مال اور مضبوط پیروکار ہیں۔ میرا مال کبھی ختم نہیں ہوگا۔' اس کے دوست نے متنبہ کیا: 'کیا تم اپنے خالق کا انکار کرتے ہو؟ کہو: یہ وہ ہے جو اللہ نے چاہا!' لیکن اس نے انکار کیا۔ کیا ہوا؟ اللہ نے رات بھر دونوں باغ تباہ کر دیے۔ آدمی ندامت میں ہاتھ ملتا رہ گیا۔ سبق: دولت بغیر تزکیہ (شکر اور خیرات کے ذریعے پاکیزگی) کے تباہی کی طرف لے جاتی ہے، اس زندگی میں بھی اور اگلی میں بھی۔"
            }
        },

        // The actual ayah reference for Two Gardens
        {
            type: "ayah",
            surah: 18,
            ayahNumber: 32,
            ayahEnd: 44,
            surahName: "Al-Kahf",
            arabic: "وَٱضْرِبْ لَهُم مَّثَلًۭا رَّجُلَيْنِ جَعَلْنَا لِأَحَدِهِمَا جَنَّتَيْنِ مِنْ أَعْنَـٰبٍۢ وَحَفَفْنَـٰهُمَا بِنَخْلٍۢ وَجَعَلْنَا بَيْنَهُمَا زَرْعًۭا",
            translation: {
                en: "And present to them an example of two men: We granted to one of them two gardens of grapevines, and We bordered them with palm trees and placed between them crops... [The story continues showing his arrogance, his friend's advice, and the ultimate destruction of his gardens as punishment for ingratitude]",
                ur: "اور انہیں دو آدمیوں کی مثال پیش کرو: ہم نے ان میں سے ایک کو انگور کے دو باغ دیے، اور ہم نے ان کے گرد کھجور لگائے اور ان کے درمیان کھیتی رکھی... [کہانی جاری رہتی ہے اس کا تکبر، اس کے دوست کی نصیحت، اور ناشکری کی سزا کے طور پر اس کے باغوں کی حتمی تباہی دکھاتی ہے]"
            }
        },

        // EXAMPLE 2: Qarun - The ultimate example of wealth corruption
        {
            type: "example",
            subheading: {
                en: "Example: Qarun (Korah) - When Wealth Becomes Your God",
                ur: "مثال: قارون - جب دولت آپ کا خدا بن جائے"
            },
            content: {
                en: "Qarun was from the people of Musa (Moses), but he oppressed them with his wealth. Allah gave him so much treasure that even carrying the keys required a group of strong men! His people advised him: 'Do not exult in your riches. Allah does not love those who exult. Give charity and do good.' But Qarun replied with pure arrogance: 'I was given this wealth because of KNOWLEDGE I possess.' He denied it came from Allah. He refused to give zakat. He paraded his wealth, and foolish people envied him saying 'We wish we had what Qarun has!' But those with knowledge said: 'Woe to you! Allah's reward is better for those who believe and do good.' Then what happened? Allah caused the earth to SWALLOW Qarun, his house, and all his wealth. He had no one to help him. The lesson: When you refuse tazkiya through zakat, when you attribute your success to yourself instead of Allah, destruction is inevitable.",
                ur: "قارون موسیٰ علیہ السلام کی قوم میں سے تھا، لیکن اس نے اپنی دولت سے ان پر ظلم کیا۔ اللہ نے اسے اتنا خزانہ دیا کہ چابیاں اٹھانے کے لیے بھی طاقتور لوگوں کی جماعت کی ضرورت تھی! اس کی قوم نے مشورہ دیا: 'اپنی دولت پر فخر نہ کرو۔ اللہ فخر کرنے والوں کو پسند نہیں کرتا۔ خیرات کرو اور نیکی کرو۔' لیکن قارون نے خالص تکبر سے جواب دیا: 'مجھے یہ دولت میرے علم کی وجہ سے ملی ہے۔' اس نے انکار کیا کہ یہ اللہ کی طرف سے آیا۔ اس نے زکوٰۃ دینے سے انکار کیا۔ اس نے اپنی دولت کی نمائش کی، اور احمق لوگوں نے حسد کیا کہ 'کاش ہمارے پاس بھی قارون جیسا ہوتا!' لیکن علم والوں نے کہا: 'تم پر افسوس! اللہ کا انعام بہتر ہے ان کے لیے جو ایمان لائیں اور نیکی کریں۔' پھر کیا ہوا؟ اللہ نے زمین کو قارون، اس کے گھر، اور اس کی ساری دولت کو نگل جانے کا حکم دیا۔ اس کا کوئی مددگار نہ تھا۔ سبق: جب آپ زکوٰۃ کے ذریعے تزکیہ سے انکار کرتے ہیں، جب آپ اپنی کامیابی کو اللہ کی بجائے خود سے منسوب کرتے ہیں، تو تباہی ناگزیر ہے۔"
            }
        },

        // The actual ayahs for Qarun
        {
            type: "ayah",
            surah: 28,
            ayahNumber: 76,
            ayahEnd: 82,
            surahName: "Al-Qasas",
            arabic: "إِنَّ قَـٰرُونَ كَانَ مِن قَوْمِ مُوسَىٰ فَبَغَىٰ عَلَيْهِمْ ۖ وَءَاتَيْنَـٰهُ مِنَ ٱلْكُنُوزِ مَآ إِنَّ مَفَاتِحَهُۥ لَتَنُوٓأُ بِٱلْعُصْبَةِ أُو۟لِى ٱلْقُوَّةِ",
            translation: {
                en: "Indeed, Qarun was from the people of Moses, but he tyrannized them. And We gave him of treasures whose keys would burden a band of strong men... [The story continues showing his arrogance, people's advice, his rejection, people's envy, and his ultimate destruction when the earth swallowed him]",
                ur: "بےشک قارون موسیٰ کی قوم میں سے تھا، لیکن اس نے ان پر ظلم کیا۔ اور ہم نے اسے خزانے دیے جن کی چابیاں طاقتور لوگوں کی جماعت کو بھی بوجھ ڈالتیں... [کہانی جاری رہتی ہے اس کا تکبر، لوگوں کی نصیحت، اس کا انکار، لوگوں کا حسد، اور جب زمین نے اسے نگل لیا تو اس کی حتمی تباہی دکھاتی ہے]"
            }
        },

        // EXAMPLE 3: The contrast - Who gives wealth to purify
        {
            type: "example",
            subheading: {
                en: "Example: The One Who Gives to Purify Himself",
                ur: "مثال: وہ جو خود کو پاک کرنے کے لیے دیتا ہے"
            },
            content: {
                en: "In contrast to Qarun, Allah describes the righteous person: He gives his wealth seeking purification (tazkiya). He does not give expecting favors in return. He gives only seeking the Face of Allah. He will be pleased (satisfied with his reward). This person understands the secret: charity is not about helping others primarily - it is about PURIFYING YOURSELF. When you give sincerely for Allah alone, your heart detaches from wealth, your trust in Allah increases, and your soul grows. This is the successful person.",
                ur: "قارون کے برعکس، اللہ نیک شخص کی تعریف کرتا ہے: وہ اپنا مال تزکیہ (پاکیزگی) چاہتے ہوئے دیتا ہے۔ وہ بدلے میں احسان کی توقع کرتے ہوئے نہیں دیتا۔ وہ صرف اللہ کی رضا چاہتے ہوئے دیتا ہے۔ وہ راضی ہو گا (اپنے انعام سے مطمئن)۔ یہ شخص راز سمجھتا ہے: خیرات بنیادی طور پر دوسروں کی مدد کرنے کے بارے میں نہیں - یہ خود کو پاک کرنے کے بارے میں ہے۔ جب آپ صرف اللہ کے لیے خلوص سے دیتے ہیں، تو آپ کا دل دولت سے الگ ہو جاتا ہے، اللہ پر آپ کا بھروسہ بڑھتا ہے، اور آپ کی روح بڑھتی ہے۔ یہ کامیاب شخص ہے۔"
            }
        },

        {
            ...
            ayahEnd: 21,
            surahName: "Al-Layl",
            arabic: "ٱلَّذِى يُؤْتِى مَالَهُۥ يَتَزَكَّىٰ ۝ وَمَا لِأَحَدٍ عِندَهُۥ مِن نِّعْمَةٍۢ تُجْزَىٰٓ ۝ إِلَّا ٱبْتِغَآءَ وَجْهِ رَبِّهِ ٱلْأَعْلَىٰ ۝ وَلَسَوْفَ يَرْضَىٰ",
            wbw: [
                {arabic: "ٱلَّذِى", transliteration: "alladhi", en: "The one who", ur: "وہ جو", root: "", rootMeaning: "who"},
                {arabic: "يُؤْتِى", transliteration: "yu'tee", en: "gives", ur: "دیتا ہے", root: "ء ت ي", rootMeaning: "give"},
                {arabic: "مَالَهُۥ", transliteration: "malahu", en: "his wealth", ur: "اپنا مال", root: "م و ل", rootMeaning: "wealth"},
                {arabic: "يَتَزَكَّىٰ", transliteration: "yatazakka", en: "purifying himself", ur: "پاک ہوتا ہے", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "وَمَا", transliteration: "wa-ma", en: "And not", ur: "اور نہیں", root: "", rootMeaning: "and not"},
                {arabic: "لِأَحَدٍ", transliteration: "li-ahadin", en: "for anyone", ur: "کسی کے لیے", root: "", rootMeaning: "for anyone"},
                {arabic: "عِندَهُۥ", transliteration: "indahu", en: "with him", ur: "اس کے پاس", root: "", rootMeaning: "with him"},
                {arabic: "مِن", transliteration: "min", en: "of", ur: "کوئی", root: "", rootMeaning: "from"},
                {arabic: "نِّعْمَةٍۢ", transliteration: "ni'matin", en: "favor", ur: "احسان", root: "ن ع م", rootMeaning: "favor/blessing"},
                {arabic: "تُجْزَىٰٓ", transliteration: "tujza", en: "to be repaid", ur: "بدلہ دیا جائے", root: "ج ز ي", rootMeaning: "reward/repay"},
                {arabic: "إِلَّا", transliteration: "illa", en: "Except", ur: "سوائے", root: "", rootMeaning: "except"},
                {arabic: "ٱبْتِغَآءَ", transliteration: "ibtighaa'a", en: "seeking", ur: "تلاش کرتے ہوئے", root: "ب غ ي", rootMeaning: "seek/desire"},
                {arabic: "وَجْهِ", transliteration: "wajhi", en: "Face", ur: "چہرہ", root: "و ج ه", rootMeaning: "face"},
                {arabic: "رَبِّهِ", transliteration: "rabbihi", en: "of his Lord", ur: "اپنے رب کا", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "ٱلْأَعْلَىٰ", transliteration: "al-a'la", en: "the Most High", ur: "بلند ترین", root: "ع ل و", rootMeaning: "high/exalted"},
                {arabic: "وَلَسَوْفَ", transliteration: "wa-lasawfa", en: "And surely", ur: "اور یقیناً", root: "", rootMeaning: "and surely"},
                {arabic: "يَرْضَىٰ", transliteration: "yarda", en: "he will be pleased", ur: "وہ راضی ہو گا", root: "ر ض و", rootMeaning: "pleased/satisfied"}
            ],
            translation: {
                en: "Who gives his wealth, purifying himself, and has in his mind no favor from anyone for which a reward is expected, but only seeking the Face of his Lord, the Most High. And he is going to be pleased.",
                ur: "جو اپنا مال دیتا ہے، خود کو پاک کرتے ہوئے، اور اس کے ذہن میں کسی کا کوئی احسان نہیں جس کا بدلہ متوقع ہو، بلکہ صرف اپنے رب اعلیٰ کی رضا چاہتے ہوئے۔ اور وہ یقیناً راضی ہو گا۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Notice the word 'yatazakka' again - he gives wealth WHILE purifying himself. Not after purification. The ACT of giving IS the purification. And notice: no expectations, no favors to be repaid, ONLY seeking Allah's Face. When you give this way, Allah promises: 'You WILL be pleased' - with your reward in the Hereafter.",
        ...
        // PART 5: THE DANGERS - Corruption & Its Consequences
        {
            type: "intro",
            subheading: {
                en: "Part 5: The Dangers - Corruption of the Soul (Dassaha)",
                ur: "حصہ 5: خطرات - نفس کی خرابی"
            },
            content: {
                en: "The Quran doesn't just tell us to purify - it warns us about the opposite: **Dassaha** (دَسَّىٰهَا) - corrupting, burying, concealing the soul. This is the antithesis of Tazkiya. Let's see what happens when you neglect purification.",
                ur: "قرآن ہمیں صرف پاک ہونے کا نہیں کہتا - بلکہ اس کے برعکس سے خبردار کرتا ہے: **دَسَّىٰهَا** - نفس کو خراب کرنا، دبانا، چھپانا۔ یہ تزکیہ کے بالکل خلاف ہے۔ آئیے دیکھتے ہیں کہ جب آپ تزکیہ کو نظرانداز کرتے ہیں تو کیا ہوتا ہے۔"
            }
        },
        {
            type: "explanation",
            content: {
                en: "The Quran doesn't just tell us to purify - it warns us about the opposite: **Dassaha** (دَسَّىٰهَا) - corrupting, burying, concealing the soul. This is the antithesis of Tazkiya.",
                ur: "قرآن ہمیں صرف پاک ہونے کا نہیں کہتا - بلکہ اس کے برعکس سے خبردار کرتا ہے: **دَسَّىٰهَا** - نفس کو خراب کرنا، دبانا، چھپانا۔ یہ تزکیہ کے بالکل خلاف ہے۔"
            }
        },

        // Qarun ayah reference
        {
            type: "ayah",
            surah: 28,
            ayahNumber: 76,
            ...
            arabic: "إِنَّ قَـٰرُونَ كَانَ مِن قَوْمِ مُوسَىٰ فَبَغَىٰ عَلَيْهِمْ ۖ وَءَاتَيْنَـٰهُ مِنَ ٱلْكُنُوزِ مَآ إِنَّ مَفَاتِحَهُۥ لَتَنُوٓأُ بِٱلْعُصْبَةِ أُو۟لِى ٱلْقُوَّةِ",
            translation: {
                en: "Indeed, Qarun was from the people of Moses, but he tyrannized them. And We gave him of treasures whose keys would burden a band of strong men... [His people advised him to give charity, but he boasted it was his own achievement. Allah caused the earth to swallow him and his dwelling]",
                ur: "بےشک قارون موسیٰ کی قوم میں سے تھا، لیکن اس نے ان پر ظلم کیا۔ اور ہم نے اسے خزانے دیے جن کی چابیاں طاقتور لوگوں کی جماعت کو بوجھ ڈالتیں... [اس کی قوم نے اسے صدقہ کرنے کا مشورہ دیا، لیکن اس نے فخر کیا کہ یہ اس کی اپنی کامیابی تھی۔ اللہ نے زمین کو اسے اور اس کے گھر کو نگل لیا]"
            }
        },

        {
            type: "explanation",
            content: {
                en: "The lesson: Wealth WITHOUT purification leads to destruction. Qarun had everything materially but was spiritually bankrupt. He refused zakat, attributed blessings to himself, and was swallowed by the earth. The very wealth he clung to became his grave. This is the fate of those who refuse to purify their wealth.",
                ur: "سبق: تزکیہ کے بغیر دولت تباہی کی طرف لے جاتی ہے۔ قارون کے پاس مادی طور پر سب کچھ تھا لیکن روحانی طور پر وہ دیوالیہ تھا۔ اس نے زکوٰۃ سے انکار کیا، نعمتوں کو اپنی طرف منسوب کیا، اور زمین نے اسے نگل لیا۔ وہی دولت جس سے وہ چمٹا تھا اس کی قبر بن گئی۔ یہ ان لوگوں کی قسمت ہے جو اپنی دولت کو پاک کرنے سے انکار کرتے ہیں۔"
            }
        },

        // EXAMPLE 3: The Believer who gives in secret
        {
            type: "example",
            subheading: {
                en: "Example: The One Who Gives in Secret - True Purification",
                ur: "مثال: جو خفیہ دیتا ہے - حقیقی تزکیہ"
            },
            content: {
                en: "Contrast those corrupted by wealth with those purified by giving. Allah describes true charity: giving in secret, not for recognition but purely for Allah. The right hand gives and the left doesn't know. No cameras, no social media posts, no tax receipts shown off. Why? Because the goal is not praise - it's PURIFICATION. When you give secretly, you purify your heart from pride, showing off, and the need for validation. This is the highest form of zakat.",
                ur: "دولت سے خراب ہونے والوں کا موازنہ ان لوگوں سے کریں جو دینے سے پاک ہوتے ہیں۔ اللہ حقیقی صدقے کی تعریف کرتا ہے: خفیہ دینا، پہچان کے لیے نہیں بلکہ خالصتاً اللہ کے لیے۔ دایاں ہاتھ دیتا ہے اور بایاں نہیں جانتا۔ کوئی کیمرے نہیں، کوئی سوشل میڈیا پوسٹس نہیں، کوئی ٹیکس رسیدیں نہیں دکھائی جاتیں۔ کیوں؟ کیونکہ مقصد تعریف نہیں - تزکیہ ہے۔ جب آپ خفیہ طور پر دیتے ہیں، تو آپ اپنے دل کو فخر، دکھاوے، اور تصدیق کی ضرورت سے پاک کرتے ہیں۔ یہ زکوٰۃ کی اعلیٰ ترین شکل ہے۔"
            }
        },

        {
            ...
            wbw: [
                {arabic: "إِن", transliteration: "in", en: "If", ur: "اگر", root: "", rootMeaning: "if"},
                {arabic: "تُبْدُوا۟", transliteration: "tubdoo", en: "you disclose", ur: "ظاہر کرو", root: "ب د و", rootMeaning: "appear/reveal"},
                {arabic: "ٱلصَّدَقَـٰتِ", transliteration: "as-sadaqat", en: "the charities", ur: "صدقات", root: "ص د ق", rootMeaning: "charity"},
                {arabic: "فَنِعِمَّا", transliteration: "fa-ni'imma", en: "then good", ur: "تو اچھا", root: "ن ع م", rootMeaning: "good/blessing"},
                {arabic: "هِىَ", transliteration: "hiya", en: "it is", ur: "ہے", root: "", rootMeaning: "it"},
                {arabic: "وَإِن", transliteration: "wa-in", en: "But if", ur: "لیکن اگر", root: "", rootMeaning: "and if"},
                {arabic: "تُخْفُوهَا", transliteration: "tukhfooha", en: "you conceal it", ur: "چھپاؤ اسے", root: "خ ف ي", rootMeaning: "hide/conceal"},
                {arabic: "وَتُؤْتُوهَا", transliteration: "wa-tu'tooha", en: "and give it", ur: "اور دو اسے", root: "ء ت ي", rootMeaning: "give"},
                {arabic: "ٱلْفُقَرَآءَ", transliteration: "al-fuqara", en: "to the poor", ur: "غریبوں کو", root: "ف ق ر", rootMeaning: "poor/needy"},
                {arabic: "فَهُوَ", transliteration: "fa-huwa", en: "then it", ur: "تو یہ", root: "", rootMeaning: "then it"},
                {arabic: "خَيْرٌۭ", transliteration: "khayrun", en: "is better", ur: "بہتر ہے", root: "خ ي ر", rootMeaning: "good/better"},
                {arabic: "لَّكُمْ", transliteration: "lakum", en: "for you", ur: "تمہارے لیے", root: "", rootMeaning: "for you"},
                {arabic: "وَيُكَفِّرُ", transliteration: "wa-yukaffiru", en: "And will remove", ur: "اور مٹا دے گا", root: "ك ف ر", rootMeaning: "cover/expiate"},
                {arabic: "عَنكُم", transliteration: "ankum", en: "from you", ur: "تم سے", root: "", rootMeaning: "from you"},
                {arabic: "مِّن", transliteration: "min", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "سَيِّـَٔاتِكُمْ", transliteration: "sayyi'atikum", en: "your evil deeds", ur: "تمہارے برے اعمال", root: "س و ء", rootMeaning: "evil/bad"}
            ],
            translation: {
                en: "If you disclose your charities, then good is that. But if you conceal them and give them to the poor, it is better for you, and He will remove from you some of your misdeeds. And Allah is All-Aware of what you do.",
                ur: "اگر تم اپنے صدقات ظاہر کرو، تو یہ اچھا ہے۔ لیکن اگر تم انہیں چھپاؤ اور غریبوں کو دو، تو یہ تمہارے لیے بہتر ہے، اور وہ تم سے تمہارے کچھ برے اعمال مٹا دے گا۔ اور اللہ جانتا ہے جو تم کرتے ہو۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Public charity is good, but SECRET charity is BETTER for YOU. Why? Because it purifies you more deeply. It removes your sins (yukaffiru ankum min sayyi'atikum). When you give without anyone knowing, you prove to yourself that you're not doing it for validation - you're doing it purely for Allah. That's when true purification happens.",
                ur: "عوامی صدقہ اچھا ہے، لیکن خفیہ صدقہ تمہارے لیے بہتر ہے۔ کیوں؟ کیونکہ یہ آپ کو زیادہ گہرائی سے پاک کرتا ہے۔ یہ آپ کے گناہوں کو مٹا دیتا ہے۔ جب آپ کسی کو جانے بغیر دیتے ہیں، تو آپ خود کو ثابت کرتے ہیں کہ آپ تصدیق کے لیے نہیں کر رہے - آپ خالصتاً اللہ کے لیے کر رہے ہیں۔ تب حقیقی تزکیہ ہوتی ہے۔"
            }
        }
,
        // ===== PART 5: THE DANGERS - Corruption & Its Consequences =====
        ...
        // Already covered: 91:10 - failure for who corrupts
        // Let's add warning about ritual without heart

        {
            ...
            ayahEnd: 7,
            surahName: "Al-Ma'un",
            arabic: "فَوَيْلٌۭ لِّلْمُصَلِّينَ ۝ ٱلَّذِينَ هُمْ عَن صَلَاتِهِمْ سَاهُونَ ۝ ٱلَّذِينَ هُمْ يُرَآءُونَ ۝ وَيَمْنَعُونَ ٱلْمَاعُونَ",
            wbw: [
                {arabic: "فَوَيْلٌۭ", transliteration: "fa-waylun", en: "So woe", ur: "تو ہلاکت", root: "و ي ل", rootMeaning: "woe/destruction"},
                {arabic: "لِّلْمُصَلِّينَ", transliteration: "lil-musalleen", en: "to those who pray", ur: "نمازیوں کے لیے", root: "ص ل و", rootMeaning: "pray"},
                {arabic: "ٱلَّذِينَ", transliteration: "alladheen", en: "those who", ur: "جو", root: "", rootMeaning: "those who"},
                {arabic: "هُمْ", transliteration: "hum", en: "they", ur: "وہ", root: "", rootMeaning: "they"},
                {arabic: "عَن", transliteration: "an", en: "about", ur: "سے", root: "", rootMeaning: "about"},
                {arabic: "صَلَاتِهِمْ", transliteration: "salatihim", en: "their prayer", ur: "اپنی نماز", root: "ص ل و", rootMeaning: "prayer"},
                {arabic: "سَاهُونَ", transliteration: "sahoon", en: "are heedless", ur: "غافل ہیں", root: "س ه و", rootMeaning: "heedless/neglectful"},
                {arabic: "ٱلَّذِينَ", transliteration: "alladheen", en: "those who", ur: "جو", root: "", rootMeaning: "those who"},
                {arabic: "هُمْ", transliteration: "hum", en: "they", ur: "وہ", root: "", rootMeaning: "they"},
                {arabic: "يُرَآءُونَ", transliteration: "yura'oon", en: "show off", ur: "دکھاوا کرتے ہیں", root: "ر ء ي", rootMeaning: "show off/hypocrisy"},
                {arabic: "وَيَمْنَعُونَ", transliteration: "wa-yamna'oon", en: "And withhold", ur: "اور روکتے ہیں", root: "م ن ع", rootMeaning: "prevent/withhold"},
                {arabic: "ٱلْمَاعُونَ", transliteration: "al-ma'oon", en: "small kindnesses", ur: "چھوٹی مدد", root: "م ع ن", rootMeaning: "assistance/small things"}
            ],
            translation: {
                en: "So woe to those who pray, those who are heedless of their prayer, those who show off, and withhold even small acts of assistance.",
                ur: "تو ہلاکت ہے ان نمازیوں کے لیے، جو اپنی نماز سے غافل ہیں، جو دکھاوا کرتے ہیں، اور چھوٹی مدد بھی روکتے ہیں۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "SHOCK: 'Woe to those who PRAY'! How? Because they pray without consciousness (sahoon - heedless), they pray for show (yura'oon), and they refuse to help others even in small ways (yamna'oon al-ma'oon). This is ritual without purification. They go through the motions but their hearts are dead. Salah without tazkiya is worthless. Zakat without sincerity is rejected.",
                ur: "حیرت: 'ہلاکت ہے ان کے لیے جو نماز پڑھتے ہیں'! کیسے؟ کیونکہ وہ شعور کے بغیر نماز پڑھتے ہیں (ساہون - غافل)، وہ دکھاوے کے لیے نماز پڑھتے ہیں، اور وہ چھوٹے طریقوں سے بھی دوسروں کی مدد کرنے سے انکار کرتے ہیں۔ یہ تزکیہ کے بغیر رسم ہے۔ وہ حرکات کرتے ہیں لیکن ان کے دل مردہ ہیں۔ تزکیہ کے بغیر نماز بیکار ہے۔ خلوص کے بغیر زکوٰۃ مسترد ہے۔"
            }
        },

        // Those who turn away from remembrance
        {
            type: "ayah",
            surah: 20,
            ayahNumber: 124,
            ayahEnd: 126,
            surahName: "Ta-Ha",
            arabic: "وَمَنْ أَعْرَضَ عَن ذِكْرِى فَإِنَّ لَهُۥ مَعِيشَةًۭ ضَنكًۭا وَنَحْشُرُهُۥ يَوْمَ ٱلْقِيَـٰمَةِ أَعْمَىٰ ۝ قَالَ رَبِّ لِمَ حَشَرْتَنِىٓ أَعْمَىٰ وَقَدْ كُنتُ بَصِيرًۭا ۝ قَالَ كَذَٰلِكَ أَتَتْكَ ءَايَـٰتُنَا فَنَسِيتَهَا ۖ وَكَذَٰلِكَ ٱلْيَوْمَ تُنسَىٰ",
            wbw: [
                {arabic: "وَمَنْ", transliteration: "wa-man", en: "And whoever", ur: "اور جس نے", root: "", rootMeaning: "and who"},
                {arabic: "أَعْرَضَ", transliteration: "a'rada", en: "turns away", ur: "منہ موڑا", root: "ع ر ض", rootMeaning: "turn away"},
                {arabic: "عَن", transliteration: "an", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "ذِكْرِى", transliteration: "dhikree", en: "My remembrance", ur: "میری یاد", root: "ذ ك ر", rootMeaning: "remember"},
                {arabic: "فَإِنَّ", transliteration: "fa-inna", en: "then indeed", ur: "تو بےشک", root: "", rootMeaning: "then indeed"},
                {arabic: "لَهُۥ", transliteration: "lahu", en: "for him", ur: "اس کے لیے", root: "", rootMeaning: "for him"},
                {arabic: "مَعِيشَةًۭ", transliteration: "ma'ishatan", en: "a life", ur: "زندگی", root: "ع ي ش", rootMeaning: "life/livelihood"},
                {arabic: "ضَنكًۭا", transliteration: "dankan", en: "straitened", ur: "تنگ", root: "ض ن ك", rootMeaning: "constricted/difficult"},
                {arabic: "وَنَحْشُرُهُۥ", transliteration: "wa-nahshuruhu", en: "and We will gather him", ur: "اور اٹھائیں گے اسے", root: "ح ش ر", rootMeaning: "gather/resurrect"},
                {arabic: "يَوْمَ", transliteration: "yawma", en: "on Day", ur: "دن", root: "", rootMeaning: "day"},
                {arabic: "ٱلْقِيَـٰمَةِ", transliteration: "al-qiyamah", en: "of Resurrection", ur: "قیامت کے", root: "ق و م", rootMeaning: "resurrection"},
                {arabic: "أَعْمَىٰ", transliteration: "a'ma", en: "blind", ur: "اندھا", root: "ع م ي", rootMeaning: "blind"}
            ],
            translation: {
                en: "And whoever turns away from My remembrance - indeed, he will have a depressed life, and We will gather him on the Day of Resurrection blind. He will say: 'My Lord, why have you raised me blind while I was seeing?' Allah will say: 'Thus did Our signs come to you, and you forgot them. And thus will you this Day be forgotten.'",
                ur: "اور جو میری یاد سے منہ موڑے گا - بےشک، اس کی زندگی تنگ ہوگی، اور ہم اسے قیامت کے دن اندھا اٹھائیں گے۔ وہ کہے گا: 'اے میرے رب، تو نے مجھے اندھا کیوں اٹھایا جبکہ میں دیکھتا تھا؟' اللہ کہے گا: 'اسی طرح تمہارے پاس ہماری نشانیاں آئیں، اور تم نے انہیں بھلا دیا۔ اور اسی طرح آج تم بھلا دیے جاؤ گے۔'"
            }
        },

        {
            type: "explanation",
            content: {
                en: "The consequence of turning away from Allah's remembrance: a DEPRESSED life (ma'ishah danka) - anxiety, emptiness, restlessness despite material comfort. Then blindness in the Hereafter. You forgot Allah, so Allah will forget you. This is life without tazkiya - outer success but inner death. The unpurified soul lives in constant anguish.",
                ur: "اللہ کی یاد سے منہ موڑنے کا نتیجہ: ایک افسردہ زندگی (معیشۃ ضنکاً) - بے چینی، خالی پن، بے قراری مادی آرام کے باوجود۔ پھر آخرت میں اندھا پن۔ آپ نے اللہ کو بھلا دیا، تو اللہ آپ کو بھلا دے گا۔ یہ تزکیہ کے بغیر زندگی ہے - ظاہری کامیابی لیکن باطنی موت۔ غیر پاک روح مسلسل اذیت میں رہتی ہے۔"
            }
        },
        ...
        // The three types of souls
        {
            ...
            ayahEnd: 30,
            surahName: "Al-Fajr",
            arabic: "يَـٰٓأَيَّتُهَا ٱلنَّفْسُ ٱلْمُطْمَئِنَّةُ ۝ ٱرْجِعِىٓ إِلَىٰ رَبِّكِ رَاضِيَةًۭ مَّرْضِيَّةًۭ ۝ فَٱدْخُلِى فِى عِبَـٰدِى ۝ وَٱدْخُلِى جَنَّتِى",
            wbw: [
                {arabic: "يَـٰٓأَيَّتُهَا", transliteration: "ya-ayyatuha", en: "O", ur: "اے", root: "", rootMeaning: "O"},
                {arabic: "ٱلنَّفْسُ", transliteration: "an-nafsu", en: "the soul", ur: "نفس", root: "ن ف س", rootMeaning: "soul/self"},
                {arabic: "ٱلْمُطْمَئِنَّةُ", transliteration: "al-mutma'innah", en: "at peace", ur: "مطمئن", root: "ط م ن", rootMeaning: "tranquil/peaceful"},
                {arabic: "ٱرْجِعِىٓ", transliteration: "irji'ee", en: "Return", ur: "واپس آ", root: "ر ج ع", rootMeaning: "return"},
                {arabic: "إِلَىٰ", transliteration: "ila", en: "to", ur: "کی طرف", root: "", rootMeaning: "to"},
                {arabic: "رَبِّكِ", transliteration: "rabbiki", en: "your Lord", ur: "اپنے رب", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "رَاضِيَةًۭ", transliteration: "radiyatan", en: "well-pleased", ur: "راضی", root: "ر ض و", rootMeaning: "pleased/satisfied"},
                {arabic: "مَّرْضِيَّةًۭ", transliteration: "mardiyyatan", en: "well-pleasing", ur: "پسندیدہ", root: "ر ض و", rootMeaning: "pleased"},
                {arabic: "فَٱدْخُلِى", transliteration: "fa-dkhulee", en: "So enter", ur: "تو داخل ہو", root: "د خ ل", rootMeaning: "enter"},
                {arabic: "فِى", transliteration: "fee", en: "among", ur: "میں", root: "", rootMeaning: "in"},
                {arabic: "عِبَـٰدِى", transliteration: "ibadee", en: "My servants", ur: "میرے بندوں", root: "ع ب د", rootMeaning: "worship/servant"},
                {arabic: "وَٱدْخُلِى", transliteration: "wa-dkhulee", en: "And enter", ur: "اور داخل ہو", root: "د خ ل", rootMeaning: "enter"},
                {arabic: "جَنَّتِى", transliteration: "jannatee", en: "My Paradise", ur: "میری جنت", root: "ج ن ن", rootMeaning: "garden"}
            ],
            translation: {
                en: "O tranquil soul! Return to your Lord, well-pleased and well-pleasing. Enter among My servants, and enter My Paradise.",
                ur: "اے مطمئن نفس! اپنے رب کی طرف واپس آ، راضی اور پسندیدہ۔ میرے بندوں میں داخل ہو، اور میری جنت میں داخل ہو۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "This is the GOAL: An-Nafs Al-Mutma'innah - the tranquil, purified soul. It is pleased with Allah (radiyah) and Allah is pleased with it (mardiyyah). This is the fruit of lifelong tazkiya. While the corrupted soul is anxious and blind, the purified soul has PEACE. That's why we purify - not for rituals, but for this state of being.",
                ur: "یہ ہدف ہے: النفس المطمئنہ - مطمئن، پاک روح۔ یہ اللہ سے راضی ہے اور اللہ اس سے راضی ہے۔ یہ زندگی بھر تزکیہ کا پھل ہے۔ جبکہ خراب روح بے چین اور اندھی ہے، پاک روح میں سکون ہے۔ یہی وجہ ہے کہ ہم پاک ہوتے ہیں - رسومات کے لیے نہیں، بلکہ اس حالت کے لیے۔"
            }
        }
,
        // ===== PART 6: ALLAH'S ROLE - Divine Purification =====
        {
            type: "intro",
            subheading: {
                en: "Part 6: Allah's Role - He Purifies Whom He Wills",
                ur: "حصہ 6: اللہ کا کردار - وہ جسے چاہے پاک کرتا ہے"
            },
            content: {
                en: "We've talked about self-purification, but there's a deeper truth: ultimately, it is ALLAH who purifies. You must strive, but HE is the one who grants success. You cannot purify yourself by your own power alone. You need Allah's help, guidance, and mercy. Let's see this divine dimension of tazkiya.",
                ur: "ہم نے خود تزکیہ کے بارے میں بات کی، لیکن ایک گہری حقیقت ہے: بالآخر، یہ اللہ ہی ہے جو پاک کرتا ہے۔ آپ کو کوشش کرنی چاہیے، لیکن وہی ہے جو کامیابی عطا کرتا ہے۔ آپ خود کو صرف اپنی طاقت سے پاک نہیں کر سکتے۔ آپ کو اللہ کی مدد، رہنمائی، اور رحمت کی ضرورت ہے۔ آئیے تزکیہ کی اس الہی جہت کو دیکھتے ہیں۔"
            }
        },

        {
            ...
            ayahNumber: 49,
            surahName: "An-Nisa",
            arabic: "أَلَمْ تَرَ إِلَى ٱلَّذِينَ يُزَكُّونَ أَنفُسَهُم ۚ بَلِ ٱللَّهُ يُزَكِّى مَن يَشَآءُ وَلَا يُظْلَمُونَ فَتِيلًا",
            wbw: [
                {arabic: "أَلَمْ", transliteration: "alam", en: "Have not", ur: "کیا نہیں", root: "", rootMeaning: "have not"},
                {arabic: "تَرَ", transliteration: "tara", en: "you seen", ur: "دیکھا", root: "ر ء ي", rootMeaning: "see"},
                {arabic: "إِلَى", transliteration: "ila", en: "to", ur: "کی طرف", root: "", rootMeaning: "to"},
                {arabic: "ٱلَّذِينَ", transliteration: "alladheen", en: "those who", ur: "جو", root: "", rootMeaning: "those who"},
                {arabic: "يُزَكُّونَ", transliteration: "yuzakkoon", en: "claim purity for", ur: "پاک کہتے ہیں", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "أَنفُسَهُم", transliteration: "anfusahum", en: "themselves", ur: "اپنے آپ کو", root: "ن ف س", rootMeaning: "self"},
                {arabic: "بَلِ", transliteration: "bal", en: "Nay", ur: "بلکہ", root: "", rootMeaning: "nay/rather"},
                {arabic: "ٱللَّهُ", transliteration: "Allah", en: "Allah", ur: "اللہ", root: "ا ل ه", rootMeaning: "God"},
                {arabic: "يُزَكِّى", transliteration: "yuzakki", en: "purifies", ur: "پاک کرتا ہے", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "مَن", transliteration: "man", en: "whom", ur: "جسے", root: "", rootMeaning: "whom"},
                {arabic: "يَشَآءُ", transliteration: "yasha'u", en: "He wills", ur: "وہ چاہے", root: "ش ي ء", rootMeaning: "will/wish"}
            ],
            translation: {
                en: "Have you not seen those who claim purity for themselves? Rather, Allah purifies whom He wills, and they will not be wronged even by a thread.",
                ur: "کیا تم نے ان لوگوں کو نہیں دیکھا جو اپنے آپ کو پاک کہتے ہیں؟ بلکہ اللہ جسے چاہے پاک کرتا ہے، اور ان پر دھاگے کے برابر بھی ظلم نہیں ہوگا۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Don't claim you are pure - that's arrogance. ALLAH purifies whom He wills (yuzakki man yasha'). So what's your role? SEEK purification humbly, strive sincerely, but never declare yourself purified. Only Allah knows the state of your heart. This keeps you humble and dependent on His mercy, which is the essence of tazkiya.",
                ur: "یہ دعوی نہ کرو کہ تم پاک ہو - یہ تکبر ہے۔ اللہ جسے چاہے پاک کرتا ہے۔ تو آپ کا کردار کیا ہے؟ عاجزی سے تزکیہ تلاش کرو، سچائی سے کوشش کرو، لیکن کبھی اپنے آپ کو پاک قرار نہ دو۔ صرف اللہ آپ کے دل کی حالت جانتا ہے۔ یہ آپ کو عاجز اور اس کی رحمت پر منحصر رکھتا ہے، جو تزکیہ کا جوہر ہے۔"
            }
        },

        {
            ...
            ayahNumber: 21,
            surahName: "An-Nur",
            arabic: "وَلَوْلَا فَضْلُ ٱللَّهِ عَلَيْكُمْ وَرَحْمَتُهُۥ مَا زَكَىٰ مِنكُم مِّنْ أَحَدٍ أَبَدًۭا وَلَـٰكِنَّ ٱللَّهَ يُزَكِّى مَن يَشَآءُ ۗ وَٱللَّهُ سَمِيعٌ عَلِيمٌۭ",
            wbw: [
                {arabic: "وَلَوْلَا", transliteration: "wa-lawla", en: "And if not for", ur: "اور اگر نہ ہوتا", root: "", rootMeaning: "if not for"},
                {arabic: "فَضْلُ", transliteration: "fadlu", en: "the grace", ur: "فضل", root: "ف ض ل", rootMeaning: "grace/favor"},
                {arabic: "ٱللَّهِ", transliteration: "Allah", en: "of Allah", ur: "اللہ کا", root: "ا ل ه", rootMeaning: "God"},
                {arabic: "عَلَيْكُمْ", transliteration: "alaykum", en: "upon you", ur: "تم پر", root: "", rootMeaning: "upon you"},
                {arabic: "وَرَحْمَتُهُۥ", transliteration: "wa-rahmatuhu", en: "and His mercy", ur: "اور اس کی رحمت", root: "ر ح م", rootMeaning: "mercy"},
                {arabic: "مَا", transliteration: "ma", en: "not", ur: "نہیں", root: "", rootMeaning: "not"},
                {arabic: "زَكَىٰ", transliteration: "zaka", en: "would have been pure", ur: "پاک ہوتا", root: "ز ك و", rootMeaning: "purify"},
                {arabic: "مِنكُم", transliteration: "minkum", en: "from you", ur: "تم میں سے", root: "", rootMeaning: "from you"},
                {arabic: "مِّنْ", transliteration: "min", en: "any", ur: "کوئی", root: "", rootMeaning: "any"},
                {arabic: "أَحَدٍ", transliteration: "ahadin", en: "one", ur: "ایک", root: "", rootMeaning: "one"},
                {arabic: "أَبَدًۭا", transliteration: "abadan", en: "ever", ur: "کبھی", root: "", rootMeaning: "ever"}
            ],
            translation: {
                en: "And if not for the grace of Allah upon you and His mercy, not one of you would have been purified, ever. But Allah purifies whom He wills. And Allah is Hearing and Knowing.",
                ur: "اور اگر اللہ کا فضل اور اس کی رحمت تم پر نہ ہوتی، تو تم میں سے کوئی ایک بھی کبھی پاک نہ ہوتا۔ لیکن اللہ جسے چاہے پاک کرتا ہے۔ اور اللہ سننے والا جاننے والا ہے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "POWERFUL: Without Allah's grace (fadl) and mercy (rahmah), NOT ONE of you would ever be purified. Zero. Your efforts mean nothing without His help. So HOW do you get purified? Strive your utmost, then BEG Allah for His grace. Make dua constantly: 'Ya Allah, purify my heart, my wealth, my intentions.' Tazkiya is a partnership: you strive, Allah grants success.",
                ur: "طاقتور: اللہ کے فضل اور رحمت کے بغیر، تم میں سے کوئی ایک بھی کبھی پاک نہیں ہوتا۔ صفر۔ آپ کی کوششیں اس کی مدد کے بغیر کچھ نہیں۔ تو آپ کیسے پاک ہوتے ہیں؟ اپنی پوری کوشش کرو، پھر اللہ سے اس کے فضل کی بھیک مانگو۔ مسلسل دعا کرو: 'یا اللہ، میرے دل، میری دولت، میری نیتوں کو پاک کر۔' تزکیہ ایک شراکت داری ہے: آپ کوشش کرتے ہیں، اللہ کامیابی عطا کرتا ہے۔"
            }
        },

        // Example: Maryam's purity
        {
            type: "ayah",
            surah: 19,
            ayahNumber: 19,
            ...
            wbw: [
                {arabic: "قَالَ", transliteration: "qala", en: "He said", ur: "کہا", root: "ق و ل", rootMeaning: "say"},
                {arabic: "إِنَّمَآ", transliteration: "innama", en: "Only", ur: "صرف", root: "", rootMeaning: "only"},
                {arabic: "أَنَا۠", transliteration: "ana", en: "I am", ur: "میں ہوں", root: "", rootMeaning: "I"},
                {arabic: "رَسُولُ", transliteration: "rasoolu", en: "a messenger", ur: "رسول", root: "ر س ل", rootMeaning: "messenger"},
                {arabic: "رَبِّكِ", transliteration: "rabbiki", en: "of your Lord", ur: "تیرے رب کا", root: "ر ب ب", rootMeaning: "Lord"},
                {arabic: "لِأَهَبَ", transliteration: "li-ahaba", en: "to give", ur: "دینے کے لیے", root: "و ه ب", rootMeaning: "give/grant"},
                {arabic: "لَكِ", transliteration: "laki", en: "to you", ur: "تجھے", root: "", rootMeaning: "to you"},
                {arabic: "غُلَـٰمًۭا", transliteration: "ghulaman", en: "a boy", ur: "بیٹا", root: "غ ل م", rootMeaning: "boy/son"},
                {arabic: "زَكِيًّۭا", transliteration: "zakiyyan", en: "pure", ur: "پاک", root: "ز ك و", rootMeaning: "pure/righteous"}
            ],
            translation: {
                en: "He said: 'I am only a messenger from your Lord to give you a pure boy.'",
                ur: "اس نے کہا: 'میں صرف تیرے رب کا رسول ہوں تاکہ تجھے ایک پاک بیٹا دوں۔'"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Prophet Isa (Jesus) is described as 'ghulaman zakiyyan' - a pure boy. Not by his own doing - he was CREATED pure by Allah's will. Similarly, Allah can purify anyone He chooses. Your job is to seek it, His job is to grant it. Don't despair if you feel impure - keep asking Allah, keep striving. He can purify the most corrupt heart if it turns to Him sincerely.",
                ur: "نبی عیسیٰ علیہ السلام کو 'غلاماً زکیاً' - ایک پاک بیٹا کہا گیا۔ اپنے کرنے سے نہیں - وہ اللہ کی مرضی سے پاک پیدا ہوئے۔ اسی طرح، اللہ جسے چاہے پاک کر سکتا ہے۔ آپ کا کام اسے تلاش کرنا ہے، اس کا کام اسے عطا کرنا ہے۔ ناامید نہ ہوں اگر آپ ناپاک محسوس کرتے ہیں - اللہ سے مانگتے رہیں، کوشش کرتے رہیں۔ وہ سب سے زیادہ خراب دل کو پاک کر سکتا ہے اگر وہ سچائی سے اس کی طرف رجوع کرے۔"
            }
        }
,
        // ===== PART 7: PRACTICAL INTEGRATION - Living Tazkiya Daily =====
        {
            type: "intro",
            subheading: {
                en: "Part 7: Practical Integration - The Daily Path of Purification",
                ur: "حصہ 7: عملی انضمام - تزکیہ کا روزانہ راستہ"
            },
            content: {
                en: "We've seen the foundation, the prophetic mission, self-purification, wealth purification, the dangers, and Allah's role. Now the question: HOW do you actually LIVE this? What does a life of tazkiya look like day-to-day? The Quran gives us practical guidance.",
                ur: "ہم نے بنیاد، نبوی مشن، خود تزکیہ، دولت کی تزکیہ، خطرات، اور اللہ کا کردار دیکھا ہے۔ اب سوال: آپ اسے حقیقت میں کیسے جیتے ہیں؟ تزکیہ کی زندگی روز مرہ کیسی لگتی ہے؟ قرآن ہمیں عملی رہنمائی دیتا ہے۔"
            }
        },

        // Constant remembrance vs heedlessness
        {
            type: "ayah",
            surah: 33,
            ayahNumber: 41,
            ayahEnd: 42,
            surahName: "Al-Ahzab",
            arabic: "يَـٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُوا۟ ٱذْكُرُوا۟ ٱللَّهَ ذِكْرًۭا كَثِيرًۭا ۝ وَسَبِّحُوهُ بُكْرَةًۭ وَأَصِيلًا",
            wbw: [
                {arabic: "يَـٰٓأَيُّهَا", transliteration: "ya-ayyuha", en: "O", ur: "اے", root: "", rootMeaning: "O"},
                {arabic: "ٱلَّذِينَ", transliteration: "alladheen", en: "those who", ur: "جو", root: "", rootMeaning: "those who"},
                {arabic: "ءَامَنُوا۟", transliteration: "amanoo", en: "believe", ur: "ایمان لائے", root: "ء م ن", rootMeaning: "believe"},
                {arabic: "ٱذْكُرُوا۟", transliteration: "udhkuroo", en: "remember", ur: "یاد کرو", root: "ذ ك ر", rootMeaning: "remember"},
                {arabic: "ٱللَّهَ", transliteration: "Allah", en: "Allah", ur: "اللہ", root: "ا ل ه", rootMeaning: "God"},
                {arabic: "ذِكْرًۭا", transliteration: "dhikran", en: "remembrance", ur: "یاد", root: "ذ ك ر", rootMeaning: "remembrance"},
                {arabic: "كَثِيرًۭا", transliteration: "katheeran", en: "much", ur: "بہت", root: "ك ث ر", rootMeaning: "abundant"},
                {arabic: "وَسَبِّحُوهُ", transliteration: "wa-sabbihoohu", en: "And glorify Him", ur: "اور تسبیح کرو اس کی", root: "س ب ح", rootMeaning: "glorify"},
                {arabic: "بُكْرَةًۭ", transliteration: "bukratan", en: "morning", ur: "صبح", root: "ب ك ر", rootMeaning: "morning/early"},
                {arabic: "وَأَصِيلًا", transliteration: "wa-aseelan", en: "and evening", ur: "اور شام", root: "ء ص ل", rootMeaning: "evening"}
            ],
            translation: {
                en: "O you who believe, remember Allah with abundant remembrance, and glorify Him morning and evening.",
                ur: "اے ایمان والو، اللہ کو بہت یاد کرو، اور صبح و شام اس کی تسبیح کرو۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "The METHOD of daily tazkiya: Dhikr Kathira - ABUNDANT remembrance of Allah. Not just 5 daily prayers. CONSTANT awareness. Morning, evening, at work, at home, while driving, while eating. Keep your tongue and heart attached to Allah. This is the opposite of ghafla (heedlessness). Tazkiya is living in continuous consciousness of Allah.",
                ur: "روزانہ تزکیہ کا طریقہ: ذکر کثیرا - اللہ کی بہت یاد۔ صرف 5 نمازیں نہیں۔ مسلسل آگاہی۔ صبح، شام، کام پر، گھر میں، گاڑی چلاتے ہوئے، کھاتے ہوئے۔ اپنی زبان اور دل کو اللہ سے جوڑے رکھیں۔ یہ غفلت کے برعکس ہے۔ تزکیہ اللہ کے مسلسل شعور میں جینا ہے۔"
            }
        },
        ...
        // Spending in ease and hardship
        {
            ...
            wbw: [
                {arabic: "ٱلَّذِينَ", transliteration: "alladheen", en: "Those who", ur: "جو", root: "", rootMeaning: "those who"},
                {arabic: "يُنفِقُونَ", transliteration: "yunfiqoon", en: "spend", ur: "خرچ کرتے ہیں", root: "ن ف ق", rootMeaning: "spend"},
                {arabic: "فِى", transliteration: "fee", en: "in", ur: "میں", root: "", rootMeaning: "in"},
                {arabic: "ٱلسَّرَّآءِ", transliteration: "as-sarra'i", en: "ease", ur: "آسانی", root: "س ر ر", rootMeaning: "ease/prosperity"},
                {arabic: "وَٱلضَّرَّآءِ", transliteration: "wad-darra'i", en: "and hardship", ur: "اور تنگی", root: "ض ر ر", rootMeaning: "hardship/adversity"},
                {arabic: "وَٱلْكَـٰظِمِينَ", transliteration: "wal-kadhimeen", en: "and those who restrain", ur: "اور روکنے والے", root: "ك ظ م", rootMeaning: "restrain/control"},
                {arabic: "ٱلْغَيْظَ", transliteration: "al-ghaydha", en: "anger", ur: "غصے کو", root: "غ ي ظ", rootMeaning: "anger/rage"},
                {arabic: "وَٱلْعَافِينَ", transliteration: "wal-'afeen", en: "and those who pardon", ur: "اور معاف کرنے والے", root: "ع ف و", rootMeaning: "pardon/forgive"},
                {arabic: "عَنِ", transliteration: "an", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "ٱلنَّاسِ", transliteration: "an-nas", en: "the people", ur: "لوگوں کو", root: "ن و س", rootMeaning: "people"}
            ],
            translation: {
                en: "Those who spend in ease and hardship, who restrain anger and pardon people. And Allah loves the doers of good.",
                ur: "وہ جو آسانی اور تنگی میں خرچ کرتے ہیں، جو غصے کو روکتے ہیں اور لوگوں کو معاف کرتے ہیں۔ اور اللہ نیک کام کرنے والوں سے محبت کرتا ہے۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "Three DAILY practices of purification: 1) Spend (yunfiqoon) in good times AND bad - don't wait to be rich, purify your wealth NOW. 2) Restrain anger (kadhimeen al-ghaydh) - control your nafs when it wants to explode. 3) Pardon people (al-'afeen) - let go of grudges, forgive freely. Do these daily and you WILL be purified. Allah loves the muhsineen - those who do ihsan through constant practice.",
                ur: "تزکیہ کی تین روزانہ مشقیں: 1) اچھے اور برے وقت میں خرچ کرو - امیر ہونے کا انتظار نہ کرو، ابھی اپنی دولت کو پاک کرو۔ 2) غصے کو روکو - جب آپ کا نفس پھٹنا چاہے تو کنٹرول کرو۔ 3) لوگوں کو معاف کرو - کینے چھوڑو، آزادانہ معاف کرو۔ یہ روزانہ کرو اور آپ پاک ہو جاؤ گے۔ اللہ محسنین سے محبت کرتا ہے - وہ جو مسلسل عمل کے ذریعے احسان کرتے ہیں۔"
            }
        },

        // Recite what is revealed and establish prayer
        {
            type: "ayah",
            surah: 29,
            ayahNumber: 45,
            ...
            wbw: [
                {arabic: "ٱتْلُ", transliteration: "utlu", en: "Recite", ur: "تلاوت کرو", root: "ت ل و", rootMeaning: "recite/follow"},
                {arabic: "مَآ", transliteration: "ma", en: "what", ur: "جو", root: "", rootMeaning: "what"},
                {arabic: "أُوحِىَ", transliteration: "oohiya", en: "has been revealed", ur: "وحی کیا گیا", root: "و ح ي", rootMeaning: "reveal"},
                {arabic: "إِلَيْكَ", transliteration: "ilayka", en: "to you", ur: "تم پر", root: "", rootMeaning: "to you"},
                {arabic: "مِنَ", transliteration: "mina", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "ٱلْكِتَـٰبِ", transliteration: "al-kitab", en: "the Book", ur: "کتاب", root: "ك ت ب", rootMeaning: "book"},
                {arabic: "وَأَقِمِ", transliteration: "wa-aqim", en: "and establish", ur: "اور قائم کرو", root: "ق و م", rootMeaning: "establish"},
                {arabic: "ٱلصَّلَوٰةَ", transliteration: "as-salah", en: "the prayer", ur: "نماز", root: "ص ل و", rootMeaning: "prayer"},
                {arabic: "إِنَّ", transliteration: "inna", en: "Indeed", ur: "بےشک", root: "", rootMeaning: "indeed"},
                {arabic: "ٱلصَّلَوٰةَ", transliteration: "as-salah", en: "the prayer", ur: "نماز", root: "ص ل و", rootMeaning: "prayer"},
                {arabic: "تَنْهَىٰ", transliteration: "tanha", en: "prevents", ur: "روکتی ہے", root: "ن ه ي", rootMeaning: "prevent/forbid"},
                {arabic: "عَنِ", transliteration: "an", en: "from", ur: "سے", root: "", rootMeaning: "from"},
                {arabic: "ٱلْفَحْشَآءِ", transliteration: "al-fahsha'i", en: "immorality", ur: "بے حیائی", root: "ف ح ش", rootMeaning: "immorality/indecency"},
                {arabic: "وَٱلْمُنكَرِ", transliteration: "wal-munkar", en: "and wrongdoing", ur: "اور برائی", root: "ن ك ر", rootMeaning: "wrong/evil"},
                {arabic: "وَلَذِكْرُ", transliteration: "wa-la-dhikru", en: "And remembrance", ur: "اور یاد", root: "ذ ك ر", rootMeaning: "remember"},
                {arabic: "ٱللَّهِ", transliteration: "Allah", en: "of Allah", ur: "اللہ کی", root: "ا ل ه", rootMeaning: "God"},
                {arabic: "أَكْبَرُ", transliteration: "akbar", en: "is greater", ur: "سب سے بڑی ہے", root: "ك ب ر", rootMeaning: "great/big"}
            ],
            translation: {
                en: "Recite what has been revealed to you of the Book and establish prayer. Indeed, prayer prevents immorality and wrongdoing, and the remembrance of Allah is greater. And Allah knows what you do.",
                ur: "تلاوت کرو جو تم پر کتاب سے وحی کیا گیا اور نماز قائم کرو۔ بےشک نماز بے حیائی اور برائی سے روکتی ہے، اور اللہ کی یاد سب سے بڑی ہے۔ اور اللہ جانتا ہے جو تم کرتے ہیں۔"
            }
        },

        {
            type: "explanation",
            content: {
                en: "TWO daily purifiers: 1) RECITE the Quran (utlu ma oohiya ilayka) - not just read, but reflect and apply. 2) ESTABLISH prayer (aqim as-salah) - with presence, not ritual. Prayer PREVENTS sin (tanha an al-fahsha' wal-munkar). How? Because if you truly remember Allah 5 times daily with your heart, you can't live in sin. And dhikr Allah (remembrance) is AKBAR (greatest). This is the daily routine of tazkiya.",
                ur: "دو روزانہ پاک کرنے والے: 1) قرآن کی تلاوت کرو - صرف پڑھنا نہیں، بلکہ غور کرو اور لاگو کرو۔ 2) نماز قائم کرو - حضوری کے ساتھ، رسم نہیں۔ نماز گناہ سے روکتی ہے۔ کیسے؟ کیونکہ اگر آپ حقیقت میں دن میں 5 بار دل سے اللہ کو یاد کرتے ہیں، تو آپ گناہ میں نہیں رہ سکتے۔ اور ذکر اللہ سب سے بڑی ہے۔ یہ تزکیہ کا روزانہ معمول ہے۔"
            }
        },

        // Final comprehensive ayah - successful believers
        {
            type: "ayah",
            surah: 23,
            ayahNumber: 1,
            ayahEnd: 11,
            surahName: "Al-Mu'minun",
            arabic: "قَدْ أَفْلَحَ ٱلْمُؤْمِنُونَ ۝ ٱلَّذِينَ هُمْ فِى صَلَاتِهِمْ خَـٰشِعُونَ ۝ وَٱلَّذِينَ هُمْ عَنِ ٱللَّغْوِ مُعْرِضُونَ ۝ وَٱلَّذِينَ هُمْ لِلزَّكَوٰةِ فَـٰعِلُونَ...",
            translation: {
                en: "Certainly successful are the believers: Those who are humbly submissive in their prayers, and who turn away from ill speech, and who are active in giving zakah, and who guard their chastity... Those are the inheritors who will inherit Paradise, wherein they will abide eternally.",
                ur: "یقیناً کامیاب ہوئے ایمان والے: جو اپنی نمازوں میں خشوع کرنے والے ہیں، اور جو بیہودہ باتوں سے منہ موڑتے ہیں، اور جو زکوٰۃ دینے میں فعال ہیں، اور جو اپنی شرمگاہوں کی حفاظت کرتے ہیں... یہی وارث ہیں جو جنت کے وارث ہوں گے، جس میں وہ ہمیشہ رہیں گے۔"
            }
        },
        ...
        // CONCLUSION
        {
            type: "explanation",
            subheading: {
                en: "Conclusion: The Heart of Your Islam",
                ur: "نتیجہ: آپ کے اسلام کا قلب"
            },
            content: {
                en: "This is not just another topic. This IS Islam. The prophets came to purify you. The Quran was sent to purify you. Salah purifies your connection to Allah. Zakat purifies your wealth and heart. Every command in Islam serves one purpose: TAZKIYA - the transformation of your soul from darkness to light, from greed to generosity, from heedlessness to consciousness, from corruption to purity.\n\nSuccess is not in how much you know, how many prayers you pray, or how much charity you give. Success is in ONE thing: Did you purify your soul? (Qad aflaha man zakkaha).\n\nSo today, NOW, make the intention: Ya Allah, I want to be purified. Cleanse my heart, purify my wealth, transform my character. Make me among the mutma'innah - the tranquil souls who return to You pleased and pleasing.\n\nThis is the heart of Islam. This is the path to Paradise. May Allah purify us all. Ameen.",
                ur: "یہ صرف ایک اور موضوع نہیں۔ یہ اسلام ہے۔ انبیاء آپ کو پاک کرنے آئے۔ قرآن آپ کو پاک کرنے کے لیے بھیجا گیا۔ نماز اللہ سے آپ کے تعلق کو پاک کرتی ہے۔ زکوٰۃ آپ کی دولت اور دل کو پاک کرتی ہے۔ اسلام میں ہر حکم ایک مقصد کی تکمیل کرتا ہے: تزکیہ - آپ کی روح کی تاریکی سے روشنی میں، لالچ سے سخاوت میں، غفلت سے شعور میں، خرابی سے پاکیزگی میں تبدیلی۔\n\nکامیابی اس میں نہیں کہ آپ کتنا جانتے ہیں، کتنی نمازیں پڑھتے ہیں، یا کتنا صدقہ دیتے ہیں۔ کامیابی ایک چیز میں ہے: کیا آپ نے اپنی روح کو پاک کیا؟ (قد افلح من زکّٰھا)۔\n\nتو آج، ابھی، نیت کریں: یا اللہ، میں پاک ہونا چاہتا ہوں۔ میرے دل کو صاف کر، میری دولت کو پاک کر، میرے کردار کو بدل دے۔ مجھے مطمئنہ نفوس میں سے بنا دے - جو تیری طرف راضی اور پسندیدہ واپس آتے ہیں۔\n\nیہ اسلام کا قلب ہے۔ یہ جنت کا راستہ ہے۔ اللہ ہم سب کو پاک کرے۔ آمین۔"
            }
        }
    ]
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { misconceptionsData };
}
